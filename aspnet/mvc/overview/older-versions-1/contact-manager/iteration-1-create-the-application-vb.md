...
> Dans la première itération, nous créons le Gestionnaire de Contact de la façon la plus simple possible. Nous ajoutons la prise en charge pour les opérations de base de données : création, lecture, mise à jour et suppression (CRUD).
...
- Itération #1 : créer l’application. Dans la première itération, nous créons le Gestionnaire de Contact de la façon la plus simple possible. Nous ajoutons la prise en charge pour les opérations de base de données : création, lecture, mise à jour et suppression (CRUD).
...
**Figure 01**: boîte de dialogue Nouveau projet ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image2.png))
...
**Figure 02**: boîte de dialogue le projet de Test unitaire créer ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image4.png))
...
| **Nom de colonne** | **Type de données** | **Autoriser les valeurs null** |
| --- | --- | --- |
| Id | int | False |
...
**Figure 06**: The ajouter un nouvel élément de boîte de dialogue ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image12.png))
...
**Figure 10**: classe le Contact ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image20.png))
...
Dans le **ajouter une vue** boîte de dialogue, cochez la case intitulée **créer une vue fortement typée**. Sélectionnez la classe de données d’affichage ContactManager.Contact et la liste de contenu de vue. Sélection de ces options génère une vue qui affiche une liste d’enregistrements de Contact.
...
**Figure 13**: boîte de dialogue Ajouter une vue The ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image26.png))
...
**Figure 14**: activation du débogage ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image28.png))
...
**Liste 4 - Controllers\HomeController.vb (avec des méthodes de création)**
...
Dans le **ajouter une vue** boîte de dialogue, sélectionnez le **ContactManager.Contact** classe et le **créer** option pour afficher le contenu (voir Figure 17). Lorsque vous cliquez sur le **ajouter** bouton, une création de vue est générée automatiquement.
...
**Figure 17**: voyez une page explode ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image34.png))
...
**Figure 18**: The Create View ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image36.png))
...
**Liste 6 - Controllers\HomeController.vb (avec les méthodes de modification)**
...
**Figure 19**: ajout d’une vue Modifier ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image38.png))
...
**Figure 21**: vue avec le lien Modifier d’Index ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image42.png))
...
**Figure 22**: ajout de la vue de confirmation de suppression ([cliquez pour afficher l’image en taille réelle](iteration-1-create-the-application-vb/_static/image44.png))
