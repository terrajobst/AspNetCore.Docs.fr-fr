...
Après avoir choisi le modèle **Blazor (côté serveur)** dans la boîte de dialogue **Créer une application web ASP.NET Core.** , sélectionnez **Modifier** sous **Authentification** .
