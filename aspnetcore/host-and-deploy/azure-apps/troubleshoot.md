...
* IIS utilise également le [Module ASP.NET Core](xref:host-and-deploy/aspnet-core-module) pour héberger des applications. Pour des conseils de résolution des problèmes qui se rapportent spécifiquement à IIS, consultez <xref:host-and-deploy/iis/troubleshoot>.
