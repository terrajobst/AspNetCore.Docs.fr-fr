...
1. [<span data-ttu-id="f07ce-137">Création du contrôleur du Gestionnaire de magasin et sa vue de l’Index</span><span class="sxs-lookup"><span data-stu-id="f07ce-137">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
2. <span data-ttu-id="f07ce-159">Ajoutez un nouveau contrôleur.</span><span class="sxs-lookup"><span data-stu-id="f07ce-159">Add a new controller.</span></span> <span data-ttu-id="f07ce-160">Pour ce faire, cliquez sur le **contrôleurs** dossier dans l’Explorateur de solutions, sélectionnez **ajouter** , puis le **contrôleur** commande.</span><span class="sxs-lookup"><span data-stu-id="f07ce-160">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="f07ce-161">Modifier la **contrôleur** **nom** à **StoreManagerController** et assurez-vous que l’option **contrôleur MVC avec des actions de lecture/écriture vides**est sélectionnée.</span><span class="sxs-lookup"><span data-stu-id="f07ce-161">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="f07ce-162">Cliquez sur **Ajouter**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-162">Click **Add**.</span></span>
    ...
    <span data-ttu-id="f07ce-164">*Boîte de dialogue contrôleur ajouter*</span><span class="sxs-lookup"><span data-stu-id="f07ce-164">*Add Controller Dialog*</span></span>
...
3. <span data-ttu-id="f07ce-185">Dans la boîte de dialogue Ajouter une vue, vérifiez que le nom de la vue est **Index**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-185">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="f07ce-186">Sélectionnez le **créer une vue fortement typée** option, puis sélectionnez **Album (MvcMusicStore.Models)** à partir de la **classe de modèle** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="f07ce-186">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="f07ce-187">Sélectionnez **liste** à partir de la **modèle de vue de structure** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="f07ce-187">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="f07ce-188">Laissez le **moteur d’affichage** à **Razor** et les autres champs leur valeur par défaut de valeur, puis **ajouter**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-188">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="f07ce-190">*Ajout d’une vue d’Index*</span><span class="sxs-lookup"><span data-stu-id="f07ce-190">*Adding an Index View*</span></span>
...
2. <span data-ttu-id="f07ce-282">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-282">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-283">Modifier l’URL pour **/StoreManager/Edit/1** pour vérifier que les valeurs des propriétés de l’album passé sont affichées.</span><span class="sxs-lookup"><span data-stu-id="f07ce-283">Change the URL to **/StoreManager/Edit/1** to verify that the properties' values for the album passed are displayed.</span></span>
    ...
    <span data-ttu-id="f07ce-284">![Parcourir vue d’édition Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image8.png "modifier la vue Album de navigation")</span><span class="sxs-lookup"><span data-stu-id="f07ce-284">![Browsing Album's Edit View](aspnet-mvc-4-helpers-forms-and-validation/_static/image8.png "Browsing Album's Edit View")</span></span>
...
1. <span data-ttu-id="f07ce-295">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-295">Press **F5** to run the Application.</span></span>
...
1. <span data-ttu-id="f07ce-331">Ouvrez le **commencer** solution situé dans **Source/Ex4-AddingACreateView/début/** dossier.</span><span class="sxs-lookup"><span data-stu-id="f07ce-331">Open the **Begin** solution located at **Source/Ex4-AddingACreateView/Begin/** folder.</span></span> <span data-ttu-id="f07ce-332">Dans le cas contraire, vous pouvez continuer à utiliser le **fin** solution obtenue par la fin de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="f07ce-332">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>
    ...
    1. <span data-ttu-id="f07ce-333">Si vous avez ouvert le **commencer** solution, vous devez télécharger des packages NuGet manquants avant de poursuivre.</span><span class="sxs-lookup"><span data-stu-id="f07ce-333">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="f07ce-334">Pour ce faire, cliquez sur le **projet** menu et sélectionnez **gérer les Packages NuGet**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-334">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
...
<span data-ttu-id="f07ce-345">Dans cette tâche, vous allez ajouter le modèle de créer une vue qui affiche un nouveau formulaire Album (vide).</span><span class="sxs-lookup"><span data-stu-id="f07ce-345">In this task, you will add the Create View template that will display a new (empty) Album form.</span></span>
...
2. <span data-ttu-id="f07ce-357">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-357">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-358">Modifier l’URL pour **/StoreManager/créer**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-358">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="f07ce-359">Vérifiez qu’un formulaire vide s’affiche pour remplir les nouvelles propriétés de l’Album.</span><span class="sxs-lookup"><span data-stu-id="f07ce-359">Verify that an empty form is displayed for filling the new Album properties.</span></span>
    ...
    <span data-ttu-id="f07ce-360">![Créer un affichage avec un formulaire vide](aspnet-mvc-4-helpers-forms-and-validation/_static/image12.png "créer une vue avec un formulaire vide")</span><span class="sxs-lookup"><span data-stu-id="f07ce-360">![Create View with an empty form](aspnet-mvc-4-helpers-forms-and-validation/_static/image12.png "Create View with an empty form")</span></span>
...
5. <span data-ttu-id="f07ce-406">Dans la boîte de dialogue Ajouter une vue, vérifiez que le nom de la vue est **supprimer**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-406">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="f07ce-407">Sélectionnez le **créer une vue fortement typée** option et sélectionnez **Album (MvcMusicStore.Models)** à partir de la **classe de modèle** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="f07ce-407">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="f07ce-408">Sélectionnez **supprimer** à partir de la **modèle de vue de structure** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="f07ce-408">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="f07ce-409">Les autres champs avec leur valeur par défaut et cliquez sur **ajouter**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-409">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="f07ce-410">![Ajout d’une vue Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Ajout d’une vue de la suppression")</span><span class="sxs-lookup"><span data-stu-id="f07ce-410">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="f07ce-411">*Ajout d’une vue de la suppression*</span><span class="sxs-lookup"><span data-stu-id="f07ce-411">*Adding a Delete View*</span></span>
6. <span data-ttu-id="f07ce-412">Le modèle de suppression affiche tous les champs à partir du modèle.</span><span class="sxs-lookup"><span data-stu-id="f07ce-412">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="f07ce-413">Vous afficherez le titre de l’album uniquement.</span><span class="sxs-lookup"><span data-stu-id="f07ce-413">You will show only the album's title.</span></span> <span data-ttu-id="f07ce-414">Pour ce faire, remplacez le contenu de la vue par le code suivant :</span><span class="sxs-lookup"><span data-stu-id="f07ce-414">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="f07ce-415">Tâche 2 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="f07ce-415">Task 2 - Running the Application</span></span>

<span data-ttu-id="f07ce-416">Dans cette tâche, vous allez tester que le **StoreManager** **supprimer** afficher la page affiche un formulaire de suppression de confirmation.</span><span class="sxs-lookup"><span data-stu-id="f07ce-416">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="f07ce-417">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-417">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="f07ce-418">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-418">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-419">Modifier l’URL pour **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-419">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="f07ce-420">Sélectionnez un album à supprimer en cliquant sur **supprimer** et vérifiez que le nouvel affichage est téléchargé.</span><span class="sxs-lookup"><span data-stu-id="f07ce-420">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="f07ce-421">![Suppression d’un Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "suppression d’un Album")</span><span class="sxs-lookup"><span data-stu-id="f07ce-421">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="f07ce-422">*Suppression d’un Album*</span><span class="sxs-lookup"><span data-stu-id="f07ce-422">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="f07ce-423">Tâche 3 : implémentation de la méthode d’Action Delete HTTP-POST</span><span class="sxs-lookup"><span data-stu-id="f07ce-423">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="f07ce-424">Dans cette tâche, vous allez implémenter la version HTTP-POST de la méthode d’action Delete qui sera appelée quand un utilisateur clique sur le **supprimer** bouton.</span><span class="sxs-lookup"><span data-stu-id="f07ce-424">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="f07ce-425">La méthode doit supprimer l’album dans la base de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-425">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="f07ce-426">Fermez le navigateur si nécessaire, pour revenir à la fenêtre Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="f07ce-426">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="f07ce-427">Ouvrez **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="f07ce-427">Open **StoreManagerController** class.</span></span> <span data-ttu-id="f07ce-428">Pour ce faire, développez le **contrôleurs** et double-cliquez sur **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-428">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="f07ce-429">Remplacez **HTTP-POST supprimer** code de méthode d’action avec les éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="f07ce-429">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="f07ce-430">(Code d’extrait de code - *Validation - Ex5 gestion suppression HTTP-POST supprimer une action, les formulaires et les programmes d’assistance de ASP.NET MVC 4*)</span><span class="sxs-lookup"><span data-stu-id="f07ce-430">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="f07ce-431">Tâche 4 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="f07ce-431">Task 4 - Running the Application</span></span>

<span data-ttu-id="f07ce-432">Dans cette tâche, vous allez tester que le **StoreManager Delete** afficher la page vous permet de supprimer un Album et redirige ensuite à la vue d’Index StoreManager.</span><span class="sxs-lookup"><span data-stu-id="f07ce-432">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="f07ce-433">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-433">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="f07ce-434">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-434">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-435">Modifier l’URL pour **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-435">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="f07ce-436">Sélectionnez un album à supprimer en cliquant sur **supprimer.**</span><span class="sxs-lookup"><span data-stu-id="f07ce-436">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="f07ce-437">Confirmer la suppression en cliquant sur **supprimer** bouton :</span><span class="sxs-lookup"><span data-stu-id="f07ce-437">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="f07ce-438">![Suppression d’un Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "suppression d’un Album")</span><span class="sxs-lookup"><span data-stu-id="f07ce-438">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="f07ce-439">*Suppression d’un Album*</span><span class="sxs-lookup"><span data-stu-id="f07ce-439">*Deleting an Album*</span></span>
3. <span data-ttu-id="f07ce-440">Vérifiez que l’album a été supprimée, car elle n’apparaît pas dans le **Index** page.</span><span class="sxs-lookup"><span data-stu-id="f07ce-440">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="f07ce-441">Exercice 6 : Ajout de la Validation</span><span class="sxs-lookup"><span data-stu-id="f07ce-441">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="f07ce-442">Actuellement, les formulaires de créer et modifier en place sans effectuer tout type de validation.</span><span class="sxs-lookup"><span data-stu-id="f07ce-442">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="f07ce-443">Si l’utilisateur quitte un champ obligatoire vide ou des lettres de type dans le champ prix, la première erreur, que vous obtiendrez sera à partir de la base de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-443">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="f07ce-444">Vous pouvez ajouter une validation à l’application en ajoutant des Annotations de données à votre classe de modèle.</span><span class="sxs-lookup"><span data-stu-id="f07ce-444">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="f07ce-445">Grâce aux Annotations de données décrivant les règles appliquées aux propriétés de votre modèle, et ASP.NET MVC s’occupe de l’application et afficher le message approprié pour les utilisateurs.</span><span class="sxs-lookup"><span data-stu-id="f07ce-445">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="f07ce-446">Tâche 1 : ajouter des Annotations de données</span><span class="sxs-lookup"><span data-stu-id="f07ce-446">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="f07ce-447">Dans cette tâche, vous allez ajouter au modèle Album qui permettront à la page Créer et modifier des Annotations de données afficher les messages de validation lorsque cela est approprié.</span><span class="sxs-lookup"><span data-stu-id="f07ce-447">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="f07ce-448">Pour une classe de modèle simple, ajout d’une Annotation de données est uniquement géré en ajoutant un **à l’aide de** instruction pour **System.ComponentModel.DataAnnotation**, puis placer un **[obligatoire]**attribut sur les propriétés appropriées.</span><span class="sxs-lookup"><span data-stu-id="f07ce-448">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="f07ce-449">L’exemple suivant rendrait la **nom** propriété un champ obligatoire dans la vue.</span><span class="sxs-lookup"><span data-stu-id="f07ce-449">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="f07ce-450">Cela est un peu plus complexe dans le cas de cette application, où le modèle de données d’entité est généré.</span><span class="sxs-lookup"><span data-stu-id="f07ce-450">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="f07ce-451">Si vous avez ajouté des Annotations de données directement dans les classes de modèle, elles sont remplacées si vous mettez à jour le modèle à partir de la base de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-451">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="f07ce-452">Au lieu de cela, vous pouvez rendre l’utilisation des métadonnées des classes partielles qui existera pour contenir les annotations et sont associés avec le modèle de classes à l’aide la **[MetadataType]** attribut.</span><span class="sxs-lookup"><span data-stu-id="f07ce-452">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="f07ce-453">Ouvrez le **commencer** solution situé dans **Source/Ex6-AddingValidation/début/** dossier.</span><span class="sxs-lookup"><span data-stu-id="f07ce-453">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="f07ce-454">Dans le cas contraire, vous pouvez continuer à utiliser le **fin** solution obtenue par la fin de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="f07ce-454">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

    1. <span data-ttu-id="f07ce-455">Si vous avez ouvert le **commencer** solution, vous devez télécharger des packages NuGet manquants avant de poursuivre.</span><span class="sxs-lookup"><span data-stu-id="f07ce-455">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="f07ce-456">Pour ce faire, cliquez sur le **projet** menu et sélectionnez **gérer les Packages NuGet**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-456">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
    2. <span data-ttu-id="f07ce-457">Dans le **gérer les Packages NuGet** boîte de dialogue, cliquez sur **restaurer** afin de télécharger les packages manquants.</span><span class="sxs-lookup"><span data-stu-id="f07ce-457">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
    3. <span data-ttu-id="f07ce-458">Enfin, générez la solution en cliquant sur **générer** | **générer la Solution**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-458">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="f07ce-459">Un des avantages de l’utilisation de NuGet est que vous ne devez expédier toutes les bibliothèques dans votre projet, ce qui réduit la taille du projet.</span><span class="sxs-lookup"><span data-stu-id="f07ce-459">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="f07ce-460">Avec NuGet Power Tools, en spécifiant les versions de package dans le fichier Packages.config, vous serez en mesure de télécharger toutes les bibliothèques requises à la première fois que vous exécutez le projet.</span><span class="sxs-lookup"><span data-stu-id="f07ce-460">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="f07ce-461">C’est pourquoi vous devez exécuter ces étapes après avoir ouvert une solution existante à partir de ce laboratoire.</span><span class="sxs-lookup"><span data-stu-id="f07ce-461">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="f07ce-462">Ouvrez le **Album.cs** à partir de la **modèles** dossier.</span><span class="sxs-lookup"><span data-stu-id="f07ce-462">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="f07ce-463">Remplacez **Album.cs** de contenu avec le code en surbrillance, afin qu’il ressemble à ce qui suit :</span><span class="sxs-lookup"><span data-stu-id="f07ce-463">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="f07ce-464">La ligne **[DisplayFormat(ConvertEmptyStringToNull=false)]** indique que les chaînes vides à partir du modèle ne sont pas être converties en valeurs null lorsque le champ de données est mise à jour dans la source de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-464">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="f07ce-465">Ce paramètre permet d’éviter une exception lors de l’Entity Framework assigne des valeurs null pour le modèle avant de l’Annotation de données valide les champs.</span><span class="sxs-lookup"><span data-stu-id="f07ce-465">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="f07ce-466">(Code d’extrait de code - *programmes d’assistance de ASP.NET MVC 4 et de formulaires et de Validation - classe de métadonnées partielle Ex6 Album*)</span><span class="sxs-lookup"><span data-stu-id="f07ce-466">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="f07ce-467">Cela **Album** classe partielle a une **MetadataType** attribut qui pointe vers le **AlbumMetaData** classe pour les Annotations de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-467">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="f07ce-468">Voici les attributs de l’Annotation de données que vous utilisez pour annoter le modèle Album :</span><span class="sxs-lookup"><span data-stu-id="f07ce-468">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="f07ce-469">Obligatoire - indique que la propriété est un champ obligatoire</span><span class="sxs-lookup"><span data-stu-id="f07ce-469">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="f07ce-470">DisplayName - définit le texte doit être utilisé sur les champs de formulaire et des messages de validation</span><span class="sxs-lookup"><span data-stu-id="f07ce-470">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="f07ce-471">DisplayFormat - Spécifie le mode d’affichage et de mise en forme des champs de données.</span><span class="sxs-lookup"><span data-stu-id="f07ce-471">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="f07ce-472">StringLength - définit une longueur maximale pour un champ de chaîne</span><span class="sxs-lookup"><span data-stu-id="f07ce-472">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="f07ce-473">Plage - donne la valeur minimale et maximale pour un champ numérique</span><span class="sxs-lookup"><span data-stu-id="f07ce-473">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="f07ce-474">ScaffoldColumn - permet de masquer des champs à partir de formulaires de l’éditeur</span><span class="sxs-lookup"><span data-stu-id="f07ce-474">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="f07ce-475">Tâche 2 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="f07ce-475">Task 2 - Running the Application</span></span>

<span data-ttu-id="f07ce-476">Dans cette tâche, vous allez tester la validation que les pages créer et modifier des champs, en utilisant les noms d’affichage choisis dans la dernière tâche.</span><span class="sxs-lookup"><span data-stu-id="f07ce-476">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="f07ce-477">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-477">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="f07ce-478">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-478">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-479">Modifier l’URL pour **/StoreManager/créer**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-479">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="f07ce-480">Vérifiez que les noms d’affichage correspondent à celles de la classe partielle (comme **Album Art URL** au lieu de **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="f07ce-480">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="f07ce-481">Cliquez sur **créer**, sans le remplir le formulaire.</span><span class="sxs-lookup"><span data-stu-id="f07ce-481">Click **Create**, without filling the form.</span></span> <span data-ttu-id="f07ce-482">Vérifiez que vous obtenez les messages de validation correspondants.</span><span class="sxs-lookup"><span data-stu-id="f07ce-482">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="f07ce-483">![Validation des champs dans la page Créer](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "validé des champs dans la page Créer")</span><span class="sxs-lookup"><span data-stu-id="f07ce-483">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="f07ce-484">*Champs validés dans la page de création*</span><span class="sxs-lookup"><span data-stu-id="f07ce-484">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="f07ce-485">Vous pouvez vérifier que le même se produit avec le **modifier** page.</span><span class="sxs-lookup"><span data-stu-id="f07ce-485">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="f07ce-486">Modifier l’URL pour **/StoreManager/Edit/1** et vérifiez que les noms d’affichage correspondent à celles de la classe partielle (comme **Album Art URL** au lieu de **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="f07ce-486">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="f07ce-487">Vide le **titre** et **prix** champs et cliquez sur **enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-487">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="f07ce-488">Vérifiez que vous obtenez les messages de validation correspondants.</span><span class="sxs-lookup"><span data-stu-id="f07ce-488">Verify that you get the corresponding validation messages.</span></span>

    ![Champs validés dans la page de modification](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="f07ce-490">*Champs validés dans la page de modification*</span><span class="sxs-lookup"><span data-stu-id="f07ce-490">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="f07ce-491">Exercice 7 : À l’aide de jQuery non obstructive côté Client</span><span class="sxs-lookup"><span data-stu-id="f07ce-491">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="f07ce-492">Dans cet exercice, vous allez apprendre à activer la validation jQuery MVC 4 discrète côté client.</span><span class="sxs-lookup"><span data-stu-id="f07ce-492">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="f07ce-493">JQuery non obstructive utilise le préfixe de données-ajax JavaScript pour appeler des méthodes d’action sur le serveur et non intrusive l’émission de scripts clients inline.</span><span class="sxs-lookup"><span data-stu-id="f07ce-493">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="f07ce-494">Tâche 1 : exécution de l’Application avant l’activation discrète jQuery</span><span class="sxs-lookup"><span data-stu-id="f07ce-494">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="f07ce-495">Dans cette tâche, vous allez exécuter l’application avant l’inclusion de jQuery afin de comparer les deux modèles de validation.</span><span class="sxs-lookup"><span data-stu-id="f07ce-495">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="f07ce-496">Ouvrez le **commencer** solution situé dans **Source/Ex7-UnobtrusivejQueryValidation/début/** dossier.</span><span class="sxs-lookup"><span data-stu-id="f07ce-496">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="f07ce-497">Dans le cas contraire, vous pouvez continuer à utiliser le **fin** solution obtenue par la fin de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="f07ce-497">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

    1. <span data-ttu-id="f07ce-498">Si vous avez ouvert le **commencer** solution, vous devez télécharger des packages NuGet manquants avant de poursuivre.</span><span class="sxs-lookup"><span data-stu-id="f07ce-498">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="f07ce-499">Pour ce faire, cliquez sur le **projet** menu et sélectionnez **gérer les Packages NuGet**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-499">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
    2. <span data-ttu-id="f07ce-500">Dans le **gérer les Packages NuGet** boîte de dialogue, cliquez sur **restaurer** afin de télécharger les packages manquants.</span><span class="sxs-lookup"><span data-stu-id="f07ce-500">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
    3. <span data-ttu-id="f07ce-501">Enfin, générez la solution en cliquant sur **générer** | **générer la Solution**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-501">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="f07ce-502">Un des avantages de l’utilisation de NuGet est que vous ne devez expédier toutes les bibliothèques dans votre projet, ce qui réduit la taille du projet.</span><span class="sxs-lookup"><span data-stu-id="f07ce-502">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="f07ce-503">Avec NuGet Power Tools, en spécifiant les versions de package dans le fichier Packages.config, vous serez en mesure de télécharger toutes les bibliothèques requises à la première fois que vous exécutez le projet.</span><span class="sxs-lookup"><span data-stu-id="f07ce-503">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="f07ce-504">C’est pourquoi vous devez exécuter ces étapes après avoir ouvert une solution existante à partir de ce laboratoire.</span><span class="sxs-lookup"><span data-stu-id="f07ce-504">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="f07ce-505">Appuyez sur **F5** pour exécuter l’application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-505">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="f07ce-506">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-506">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-507">Parcourir **/StoreManager/créer** et cliquez sur **créer** sans le remplir le formulaire pour vérifier que vous obtenez des messages de validation :</span><span class="sxs-lookup"><span data-stu-id="f07ce-507">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="f07ce-508">![Validation du client désactivée](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "validation Client désactivée")</span><span class="sxs-lookup"><span data-stu-id="f07ce-508">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="f07ce-509">*Validation du client désactivée*</span><span class="sxs-lookup"><span data-stu-id="f07ce-509">*Client validation disabled*</span></span>
4. <span data-ttu-id="f07ce-510">Dans le navigateur, ouvrez le code source HTML :</span><span class="sxs-lookup"><span data-stu-id="f07ce-510">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="f07ce-511">Tâche 2 : Validation de Client non obstructive l’activation</span><span class="sxs-lookup"><span data-stu-id="f07ce-511">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="f07ce-512">Dans cette tâche, vous allez activer jQuery **validation client non obstructive** de **Web.config** fichier, qui est par défaut la valeur false dans tous les nouveaux projets ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="f07ce-512">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="f07ce-513">En outre, vous allez ajouter que les références pour rendre le travail de la Validation Client non obstructive de jQuery les scripts nécessaires.</span><span class="sxs-lookup"><span data-stu-id="f07ce-513">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="f07ce-514">Ouvrez **Web.Config** de fichiers à la racine du projet et vous assurer que le **ClientValidationEnabled** et **UnobtrusiveJavaScriptEnabled** clés ont la valeur **true**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-514">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="f07ce-515">Vous pouvez également activer la validation côté client par le code à Global.asax.cs pour obtenir les mêmes résultats :</span><span class="sxs-lookup"><span data-stu-id="f07ce-515">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="f07ce-516">**HtmlHelper.ClientValidationEnabled = true ;**</span><span class="sxs-lookup"><span data-stu-id="f07ce-516">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="f07ce-517">En outre, vous pouvez affecter ClientValidationEnabled attribut dans n’importe quel contrôleur d’avoir un comportement personnalisé.</span><span class="sxs-lookup"><span data-stu-id="f07ce-517">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="f07ce-518">Ouvrez **Create.cshtml** à **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-518">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="f07ce-519">Assurez-vous que les fichiers de script suivant **jquery.validate** et **jquery.validate.unobtrusive**, sont référencées dans la vue via la &quot; **~/bundles/jqueryval** &quot; offre groupée.</span><span class="sxs-lookup"><span data-stu-id="f07ce-519">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="f07ce-520">Toutes ces bibliothèques jQuery sont inclus dans les nouveaux projets de MVC 4.</span><span class="sxs-lookup"><span data-stu-id="f07ce-520">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="f07ce-521">Vous trouverez plus de bibliothèques dans le **/Scripts** dossier de votre projet.</span><span class="sxs-lookup"><span data-stu-id="f07ce-521">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="f07ce-522">Pour rendre cette validation bibliothèques fonctionnent, vous devez ajouter une référence à la bibliothèque d’infrastructure jQuery.</span><span class="sxs-lookup"><span data-stu-id="f07ce-522">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="f07ce-523">Étant donné que cette référence est déjà ajoutée à la  **\_Layout.cshtml** fichier, vous n’avez pas besoin pour l’ajouter dans cette vue particulière.</span><span class="sxs-lookup"><span data-stu-id="f07ce-523">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="f07ce-524">Tâche 3 - Application à l’aide de discrète jQuery Validation en cours d’exécution</span><span class="sxs-lookup"><span data-stu-id="f07ce-524">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="f07ce-525">Dans cette tâche, vous allez tester que le **StoreManager** créer la vue de modèle effectue la validation côté client à l’aide des bibliothèques de jQuery lorsque l’utilisateur crée un nouvel album.</span><span class="sxs-lookup"><span data-stu-id="f07ce-525">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="f07ce-526">Appuyez sur **F5** pour exécuter l’application.</span><span class="sxs-lookup"><span data-stu-id="f07ce-526">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="f07ce-527">Le projet de démarrage dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="f07ce-527">The project starts in the Home page.</span></span> <span data-ttu-id="f07ce-528">Parcourir **/StoreManager/créer** et cliquez sur **créer** sans le remplir le formulaire pour vérifier que vous obtenez des messages de validation :</span><span class="sxs-lookup"><span data-stu-id="f07ce-528">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="f07ce-529">![Validation du client avec jQuery activé](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "validation Client avec jQuery activé")</span><span class="sxs-lookup"><span data-stu-id="f07ce-529">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="f07ce-530">*Validation du client avec jQuery activé*</span><span class="sxs-lookup"><span data-stu-id="f07ce-530">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="f07ce-531">Dans le navigateur, ouvrez le code source pour créer une vue :</span><span class="sxs-lookup"><span data-stu-id="f07ce-531">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

    > [!NOTE]
    > <span data-ttu-id="f07ce-532">Pour chaque règle de validation client, jQuery non obstructive ajoute un attribut avec des données-val -*rulename*=&quot;*message*&quot;.</span><span class="sxs-lookup"><span data-stu-id="f07ce-532">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="f07ce-533">Voici une liste de balises qui discrète jQuery insère dans le champ d’entrée html pour effectuer la validation côté client :</span><span class="sxs-lookup"><span data-stu-id="f07ce-533">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
    > 
    > - <span data-ttu-id="f07ce-534">Val de données</span><span class="sxs-lookup"><span data-stu-id="f07ce-534">Data-val</span></span>
    > - <span data-ttu-id="f07ce-535">Numéro de données val</span><span class="sxs-lookup"><span data-stu-id="f07ce-535">Data-val-number</span></span>
    > - <span data-ttu-id="f07ce-536">Plage de données val</span><span class="sxs-lookup"><span data-stu-id="f07ce-536">Data-val-range</span></span>
    > - <span data-ttu-id="f07ce-537">Données val plage min / données-val-range-max</span><span class="sxs-lookup"><span data-stu-id="f07ce-537">Data-val-range-min / Data-val-range-max</span></span>
    > - <span data-ttu-id="f07ce-538">Données val requises</span><span class="sxs-lookup"><span data-stu-id="f07ce-538">Data-val-required</span></span>
    > - <span data-ttu-id="f07ce-539">Longueur de données val</span><span class="sxs-lookup"><span data-stu-id="f07ce-539">Data-val-length</span></span>
    > - <span data-ttu-id="f07ce-540">Données-val-longueur-max / données val-Longueur-min.</span><span class="sxs-lookup"><span data-stu-id="f07ce-540">Data-val-length-max / Data-val-length-min</span></span>
    > 
    > <span data-ttu-id="f07ce-541">Toutes les valeurs de données sont remplis avec le modèle **Annotation de données**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-541">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="f07ce-542">Vous pouvez ensuite exécuter toute la logique qui fonctionne au côté serveur côté client.</span><span class="sxs-lookup"><span data-stu-id="f07ce-542">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="f07ce-543">Par exemple, des attributs de prix est l’annotation de données suivant dans le modèle :</span><span class="sxs-lookup"><span data-stu-id="f07ce-543">For example, Price attribute has the following data annotation in the model:</span></span>
    > 
    > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
    > 
    > <span data-ttu-id="f07ce-544">Une fois à l’aide de jQuery non obstructive, le code généré est :</span><span class="sxs-lookup"><span data-stu-id="f07ce-544">After using Unobtrusive jQuery, the generated code is:</span></span>
    >  
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="f07ce-545">Résumé</span><span class="sxs-lookup"><span data-stu-id="f07ce-545">Summary</span></span>

<span data-ttu-id="f07ce-546">À la fin de cet atelier pratique, vous avez appris comment permettre aux utilisateurs de modifier les données stockées dans la base de données à l’aide des éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="f07ce-546">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="f07ce-547">Actions de contrôleur comme Index, créer, modifier, supprimer</span><span class="sxs-lookup"><span data-stu-id="f07ce-547">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="f07ce-548">Fonctionnalité de génération de modèles automatique de ASP.NET MVC pour afficher les propriétés d’une table HTML</span><span class="sxs-lookup"><span data-stu-id="f07ce-548">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="f07ce-549">Les applications d’assistance HTML personnalisées pour améliorer l’utilisateur expérience</span><span class="sxs-lookup"><span data-stu-id="f07ce-549">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="f07ce-550">Méthodes d’action qui réagissent appels HTTP-POST ou HTTP-GET</span><span class="sxs-lookup"><span data-stu-id="f07ce-550">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="f07ce-551">Un modèle partagé éditeur pour afficher les modèles similaires, comme créer et modifier</span><span class="sxs-lookup"><span data-stu-id="f07ce-551">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="f07ce-552">Les éléments de formulaire tels que les zones déroulantes</span><span class="sxs-lookup"><span data-stu-id="f07ce-552">Form elements like drop-downs</span></span>
- <span data-ttu-id="f07ce-553">Annotations de données pour la validation de modèle</span><span class="sxs-lookup"><span data-stu-id="f07ce-553">Data annotations for Model validation</span></span>
- <span data-ttu-id="f07ce-554">Validation côté client à l’aide de la bibliothèque de jQuery non obstructive</span><span class="sxs-lookup"><span data-stu-id="f07ce-554">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="f07ce-555">Annexe a : installation de Visual Studio Express 2012 pour le Web</span><span class="sxs-lookup"><span data-stu-id="f07ce-555">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="f07ce-556">Vous pouvez installer **Microsoft Visual Studio Express 2012 pour Web** ou un autre &quot;Express&quot; à l’aide de la version du  **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="f07ce-556">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="f07ce-557">Les instructions suivantes vous guident à travers les étapes requises pour installer *Visual studio Express 2012 pour le Web* à l’aide de *Microsoft Web Platform Installer*.</span><span class="sxs-lookup"><span data-stu-id="f07ce-557">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="f07ce-558">Accédez à [ [https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="f07ce-558">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="f07ce-559">Sinon, si vous avez déjà installé Web Platform Installer, vous pouvez ouvrir il et recherchez le produit &quot; *Visual Studio Express 2012 pour le Web avec Windows Azure SDK*&quot;.</span><span class="sxs-lookup"><span data-stu-id="f07ce-559">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*Visual Studio Express 2012 for Web with Windows Azure SDK*&quot;.</span></span>
2. <span data-ttu-id="f07ce-560">Cliquez sur **installer maintenant**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-560">Click on **Install Now**.</span></span> <span data-ttu-id="f07ce-561">Si vous n’avez pas **Web Platform Installer** vous allez être redirigé pour télécharger et installer tout d’abord.</span><span class="sxs-lookup"><span data-stu-id="f07ce-561">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="f07ce-562">Une fois **Web Platform Installer** est ouvert, cliquez sur **installer** pour démarrer le programme d’installation.</span><span class="sxs-lookup"><span data-stu-id="f07ce-562">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="f07ce-563">![Installer Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "installer Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="f07ce-563">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="f07ce-564">*Installer Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="f07ce-564">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="f07ce-565">Lisez les termes et les licences de tous les produits et cliquez sur **J’accepte** pour continuer.</span><span class="sxs-lookup"><span data-stu-id="f07ce-565">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Accepter les termes du contrat de licence](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="f07ce-567">*Accepter les termes du contrat de licence*</span><span class="sxs-lookup"><span data-stu-id="f07ce-567">*Accepting the license terms*</span></span>
5. <span data-ttu-id="f07ce-568">Attendez que le processus de téléchargement et l’installation se termine.</span><span class="sxs-lookup"><span data-stu-id="f07ce-568">Wait until the downloading and installation process completes.</span></span>

    ![Progression de l'installation](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="f07ce-570">*Progression de l’installation*</span><span class="sxs-lookup"><span data-stu-id="f07ce-570">*Installation progress*</span></span>
6. <span data-ttu-id="f07ce-571">Une fois l’installation terminée, cliquez sur **Terminer**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-571">When the installation completes, click **Finish**.</span></span>

    ![Installation est terminée](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="f07ce-573">*Installation est terminée*</span><span class="sxs-lookup"><span data-stu-id="f07ce-573">*Installation completed*</span></span>
7. <span data-ttu-id="f07ce-574">Cliquez sur **Exit** fermer Web Platform Installer.</span><span class="sxs-lookup"><span data-stu-id="f07ce-574">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="f07ce-575">Pour ouvrir Visual Studio Express pour le Web, accédez à la **Démarrer** écran et démarrer l’écriture &quot; **VS Express**&quot;, puis cliquez sur le **Visual Studio Express pour le Web** vignette.</span><span class="sxs-lookup"><span data-stu-id="f07ce-575">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express pour la vignette du Web](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="f07ce-577">*VS Express pour la vignette du Web*</span><span class="sxs-lookup"><span data-stu-id="f07ce-577">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="f07ce-578">Annexe b : à l’aide d’extraits de Code</span><span class="sxs-lookup"><span data-stu-id="f07ce-578">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="f07ce-579">Avec des extraits de code, vous avez tout le code que vous avez besoin.</span><span class="sxs-lookup"><span data-stu-id="f07ce-579">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="f07ce-580">Le document lab vous indique exactement quand vous pouvez les utiliser, comme indiqué dans l’illustration suivante.</span><span class="sxs-lookup"><span data-stu-id="f07ce-580">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="f07ce-581">![À l’aide d’extraits de code Visual Studio pour insérer du code dans votre projet](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "des extraits de code à l’aide de Visual Studio pour insérer du code dans votre projet")</span><span class="sxs-lookup"><span data-stu-id="f07ce-581">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="f07ce-582">*À l’aide d’extraits de code Visual Studio pour insérer du code dans votre projet*</span><span class="sxs-lookup"><span data-stu-id="f07ce-582">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="f07ce-583">***Pour ajouter un extrait de code à l’aide du clavier (c# uniquement)***</span><span class="sxs-lookup"><span data-stu-id="f07ce-583">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="f07ce-584">Placez le curseur où vous souhaitez insérer le code.</span><span class="sxs-lookup"><span data-stu-id="f07ce-584">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="f07ce-585">Commencez à taper le nom de l’extrait de code (sans espaces ou des traits d’union).</span><span class="sxs-lookup"><span data-stu-id="f07ce-585">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="f07ce-586">Observez comment IntelliSense affiche les noms des extraits de code de mise en correspondance.</span><span class="sxs-lookup"><span data-stu-id="f07ce-586">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="f07ce-587">Sélectionnez l’extrait de code correct (ou continuez à taper jusqu'à ce que le nom de l’extrait de code entier est sélectionné).</span><span class="sxs-lookup"><span data-stu-id="f07ce-587">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="f07ce-588">Appuyez sur la touche Tab à deux reprises pour insérer l’extrait de code à l’emplacement du curseur.</span><span class="sxs-lookup"><span data-stu-id="f07ce-588">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="f07ce-589">![Commencez à taper le nom de l’extrait de code](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "commencez à taper le nom de l’extrait de code")</span><span class="sxs-lookup"><span data-stu-id="f07ce-589">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="f07ce-590">*Commencez à taper le nom de l’extrait de code*</span><span class="sxs-lookup"><span data-stu-id="f07ce-590">*Start typing the snippet name*</span></span>

<span data-ttu-id="f07ce-591">![Appuyez sur Tab pour sélectionner l’extrait de code en surbrillance](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "appuyez sur Tab pour sélectionner l’extrait de code en surbrillance")</span><span class="sxs-lookup"><span data-stu-id="f07ce-591">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="f07ce-592">*Appuyez sur Tab pour sélectionner l’extrait de code en surbrillance*</span><span class="sxs-lookup"><span data-stu-id="f07ce-592">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="f07ce-593">![Appuyez sur Tab à nouveau et l’extrait de code sont développés](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "appuyez sur Tab à nouveau et l’extrait de code seront développe.")</span><span class="sxs-lookup"><span data-stu-id="f07ce-593">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="f07ce-594">*Appuyez sur Tab à nouveau et l’extrait de code seront développe.*</span><span class="sxs-lookup"><span data-stu-id="f07ce-594">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="f07ce-595">***Pour ajouter un extrait de code à l’aide de la souris (c#, Visual Basic et XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="f07ce-595">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="f07ce-596">Clic droit où vous souhaitez insérer l’extrait de code.</span><span class="sxs-lookup"><span data-stu-id="f07ce-596">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="f07ce-597">Sélectionnez **insérer un extrait** suivie **mes extraits de Code**.</span><span class="sxs-lookup"><span data-stu-id="f07ce-597">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="f07ce-598">Sélectionnez l’extrait de code approprié dans la liste, en cliquant dessus.</span><span class="sxs-lookup"><span data-stu-id="f07ce-598">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="f07ce-599">![Avec le bouton sur lequel vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "avec le bouton sur lequel vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait")</span><span class="sxs-lookup"><span data-stu-id="f07ce-599">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="f07ce-600">*Avec le bouton droit sur lequel vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait*</span><span class="sxs-lookup"><span data-stu-id="f07ce-600">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="f07ce-601">![Sélectionnez l’extrait de code approprié dans la liste, en cliquant dessus](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "choisir l’extrait de code approprié dans la liste, en cliquant sur celle-ci")</span><span class="sxs-lookup"><span data-stu-id="f07ce-601">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="f07ce-602">*Sélectionnez l’extrait de code approprié dans la liste, en cliquant sur celle-ci*</span><span class="sxs-lookup"><span data-stu-id="f07ce-602">*Pick the relevant snippet from the list, by clicking on it*</span></span>
