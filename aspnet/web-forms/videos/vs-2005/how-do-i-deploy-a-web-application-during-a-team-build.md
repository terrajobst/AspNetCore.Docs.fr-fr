...
---
<a name="how-do-i-deploy-a-web-application-during-a-team-build"></a>[Comment faire] Déployer une Application Web pendant une Build d’équipe ?
====================
par [Paul pirate](https://github.com/pjhacker)

Cette vidéo montre comment créer une nouvelle build d’équipe et comment déployer votre application Web dans le cadre du processus de génération. Nous voyons qu’y compris l’étape de déploiement est aussi simple que l’ajout d’une commande de copie de X pour le script de génération.
