...
====================
> La syntaxe Razor et comment l’utiliser pour afficher des informations dans les vues (V dans MVC).


- [À l’aide de l’inspecteur de Page dans ASP.NET MVC](using-page-inspector-in-aspnet-mvc.md)
- [Dynamique v. Vues fortement typées](dynamic-v-strongly-typed-views.md)
