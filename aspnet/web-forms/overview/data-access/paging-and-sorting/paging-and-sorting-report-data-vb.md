...
ms.locfileid: "37387648"
---
<a name="paging-and-sorting-report-data-vb"></a>La pagination et tri des données de rapport (VB)
====================
...
**Figure 8**: avec la pagination activé, uniquement un sous-ensemble des enregistrements sont affichés à la fois ([cliquez pour afficher l’image en taille réelle](paging-and-sorting-report-data-vb/_static/image14.png))
...
**Figure 10**: le numéro de Page actuel et le nombre Total de Pages sont affichés ([cliquez pour afficher l’image en taille réelle](paging-and-sorting-report-data-vb/_static/image20.png))
