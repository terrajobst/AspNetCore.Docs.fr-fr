...
## <a name="update-the-edit-httppost-method"></a>Mise à jour la méthode HttpPost modifier
...
## <a name="close-database-connections"></a>Connexions de fermeture de la base de données
