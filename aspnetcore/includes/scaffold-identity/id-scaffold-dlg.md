<span data-ttu-id="39cfd-101">Exécutez le Générateur de modèles automatique identité :</span><span class="sxs-lookup"><span data-stu-id="39cfd-101">Run the Identity scaffolder:</span></span>
