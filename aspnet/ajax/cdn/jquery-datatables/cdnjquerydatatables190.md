...
ms.locfileid: "30072913"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="834a1-102">jQuery DataTables à 1.9.0</span><span class="sxs-lookup"><span data-stu-id="834a1-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="834a1-103">Les fichiers suivants pour la plug-ins DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="834a1-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
