...
ms.locfileid: "30072335"
---
<a name="jquery-validation-1110"></a><span data-ttu-id="ec9a1-102">jQuery Validation 1.11.0</span><span class="sxs-lookup"><span data-stu-id="ec9a1-102">jQuery Validation 1.11.0</span></span>
====================
<span data-ttu-id="ec9a1-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="ec9a1-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ec9a1-104">Les fichiers de localisation https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages \_## .js où ## est le code d’emplacement.</span><span class="sxs-lookup"><span data-stu-id="ec9a1-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js where ## is the loc code.</span></span>
