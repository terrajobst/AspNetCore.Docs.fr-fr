...
ms.locfileid: "41832564"
---
<a name="whats-new-in-aspnet-45-and-visual-studio-2012"></a>Quelles sont les nouveautés de ASP.NET 4.5 et Visual Studio 2012
====================
...
Vous pouvez désormais encoder en HTML les résultats des expressions de liaison de données. Ajoutez un signe deux-points ( :)) à la fin de la &lt;% # préfixe qui marque l’expression de liaison de données :
