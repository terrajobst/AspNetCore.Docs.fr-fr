...
**Figure 3**: ajouter la `Global.asax` fichier au répertoire racine de votre Application Web ([cliquez pour afficher l’image en taille réelle](caching-data-at-application-startup-cs/_static/image5.png))
