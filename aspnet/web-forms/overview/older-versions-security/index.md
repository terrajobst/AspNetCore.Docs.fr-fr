...
- [ASP.NET 3.5 - Introduction à la sécurité](introduction/index.md)
    ...
    - [Configuration et questions avancées de l’authentification par formulaire (C#)](introduction/forms-authentication-configuration-and-advanced-topics-cs.md)
...
- [ASP.NET 3.5 - Appartenance](membership/index.md)
    ...
    - [Validation des informations d’identification de l’utilisateur par rapport au magasin d’utilisateurs d’appartenance (C#)](membership/validating-user-credentials-against-the-membership-user-store-cs.md)
    - [Autorisation basée sur l’utilisateur (C#)](membership/user-based-authorization-cs.md)
    - [Stockage d’informations supplémentaires sur l’utilisateur (C#)](membership/storing-additional-user-information-cs.md)
    - [Création du schéma d’appartenance dans SQL Server (VB)](membership/creating-the-membership-schema-in-sql-server-vb.md)
    - [Création de comptes d’utilisateurs (VB)](membership/creating-user-accounts-vb.md)
...
- [ASP.NET 3.5 - Rôles](roles/index.md)
    ...
    - [Autorisation basée sur le rôle (C#)](roles/role-based-authorization-cs.md)
...
- [ASP.NET 3.5 - Administration de la sécurité](admin/index.md)
    ...
    - [Déblocage et approbation des comptes d’utilisateur (C#)](admin/unlocking-and-approving-user-accounts-cs.md)
    - [Création d’une interface pour sélectionner un compte d’utilisateur parmi de nombreux comptes (VB)](admin/building-an-interface-to-select-one-user-account-from-many-vb.md)
    - [Récupération et changement des mots de passe (VB)](admin/recovering-and-changing-passwords-vb.md)
    - [Déblocage et approbation des comptes d’utilisateur (VB)](admin/unlocking-and-approving-user-accounts-vb.md)
