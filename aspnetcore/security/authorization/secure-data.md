...
* Définissez `"LocalTest:skipSSL": true` dans le *appsettings. Developement.JSON* fichiers à ignorer la spécification du protocole HTTPS. Skip HTTPS uniquement sur un ordinateur de développement.
