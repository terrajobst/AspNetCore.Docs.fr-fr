...
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="934b7-102">jQuery.Validate version 1.8.1</span><span class="sxs-lookup"><span data-stu-id="934b7-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="934b7-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="934b7-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="934b7-104">Les fichiers de localisation https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages \_## .js où ## est le code d’emplacement.</span><span class="sxs-lookup"><span data-stu-id="934b7-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
