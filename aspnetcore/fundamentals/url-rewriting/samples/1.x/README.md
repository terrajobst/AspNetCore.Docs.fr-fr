# <a name="aspnet-core-url-rewriting-sample-aspnet-core-1x"></a>Exemple de réécriture d’URL ASP.NET Core (ASP.NET Core 1.x)

Cet exemple illustre l’utilisation de l’intergiciel (middleware) de réécriture d’URL ASP.NET Core 1.x. L’application montre les options de réécriture et de redirection d’URL. Pour obtenir l’exemple correspondant à ASP.NET Core 2.x, consultez [Exemple de réécriture d’URL ASP.NET Core (ASP.NET Core 2.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/2.x).
