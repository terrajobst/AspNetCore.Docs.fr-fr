...
4. Créez un dossier nommé « signalr » à l’intérieur de la *lib* dossier dans votre projet. Copier le *signalr.js* à partir du fichier *node_modules\\ @aspnet\signalr\dist\browser*  dans ce dossier.
