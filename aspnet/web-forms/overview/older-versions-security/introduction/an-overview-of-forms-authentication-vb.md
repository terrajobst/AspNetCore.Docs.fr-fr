...
**Figure 01**: le Workflow d’authentification de formulaires ([cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image3.png))
...
**Figure 09**: le Login Page contient deux zones de texte, une case à cocher, un bouton et une étiquette ([cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image27.png))
...
**Figure 10**: l’étiquette InvalidCredentialsMessage est affiché lors de la saisie informations d’identification erronées ([cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image30.png))
...
**Figure 11**: lors de la visite de façon anonyme, un lien de journal est affiché ([cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image33.png))
...
**Figure 12**: utilisateurs authentifiés sont affichés la bienvenue ! Message ([cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image36.png))
...
**Figure 15**: The LoginView contrôle affiche Bienvenue, Jisun. ([Cliquez pour afficher l’image en taille réelle](an-overview-of-forms-authentication-vb/_static/image45.png))
