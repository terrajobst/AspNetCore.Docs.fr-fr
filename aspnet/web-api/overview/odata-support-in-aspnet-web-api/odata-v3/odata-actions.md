...
Voici pourquoi c’est important : si une action est temporaire, le serveur doit indiquer au client lorsque l’action est disponible. Pour ce faire, il comprend un lien vers l’action dans l’entité. Voici un exemple d’une entité de film :
