...
---
<a name="performing-simple-validation-vb"></a>La Validation Simple (VB)
====================
...
**Figure 03**: Create The view, soumise avec des problèmes ([cliquez pour afficher l’image en taille réelle](performing-simple-validation-vb/_static/image6.png))
