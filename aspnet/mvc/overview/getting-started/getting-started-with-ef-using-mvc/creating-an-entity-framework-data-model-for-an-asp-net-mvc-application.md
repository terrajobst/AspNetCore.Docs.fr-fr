...
> * Créer le contrôleur et des vues
...
## <a name="create-controller-and-views"></a>Créer le contrôleur et des vues
...
> * Créé le contexte de base de données
> * Base de données initialisé avec les données de test
> * Configuration d’EF 6 pour utiliser la base de données locale
> * Vues et contrôleur créée
> * Afficher la base de données
...
> [Implémenter des fonctionnalités de CRUD de base](implementing-basic-crud-functionality-with-the-entity-framework-in-asp-net-mvc-application.md)