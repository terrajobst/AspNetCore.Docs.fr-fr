...
ms.locfileid: "30070509"
---
<a name="jquery-validation-1151"></a><span data-ttu-id="200a7-102">jQuery Validation 1.15.1</span><span class="sxs-lookup"><span data-stu-id="200a7-102">jQuery Validation 1.15.1</span></span>
====================
<span data-ttu-id="200a7-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="200a7-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="200a7-104">Les fichiers de localisation https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages \_## .js où ## est le code d’emplacement.</span><span class="sxs-lookup"><span data-stu-id="200a7-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.1/localization/messages\_##.js where ## is the loc code.</span></span>
