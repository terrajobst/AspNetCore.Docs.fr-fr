...
- [Guide pratique pour](how-do-i/index.md)
    ...
    - [Création d’une application de liste de tâches avec ASP.NET MVC](how-do-i/creating-a-tasklist-application-with-aspnet-mvc.md)
    - [Création d’une application de base de données de films en 15 minutes avec ASP.NET MVC](how-do-i/creating-a-movie-database-application-in-15-minutes-with-aspnet-mvc.md)
    - [Présentation des modèles, des vues et des contrôleurs](how-do-i/understanding-models-views-and-controllers.md)
    - [Vue d’ensemble du contrôleur ASP.NET MVC](how-do-i/aspnet-mvc-controller-overview.md)
    - [Présentation des contrôleurs, des actions de contrôleur et des résultats des actions](how-do-i/understanding-controllers-controller-actions-and-action-results.md)
    - [Présentation des vues, des données des vues et des helpers HTML](how-do-i/understanding-views-view-data-and-html-helpers.md)
    - [Introduction au routage d’URL](how-do-i/an-introduction-to-url-routing.md)
    - [Prévention des attaques par injection de code JavaScript](how-do-i/preventing-javascript-injection-attacks.md)
    ...
    - [Création de helpers HTML personnalisés](how-do-i/creating-custom-html-helpers.md)
    ...
    - [MVC2 - Codage du HTML](how-do-i/mvc2-html-encoding.md)
    - [MVC2 - Helpers StronglyTyped](how-do-i/mvc2-stronglytyped-helpers.md)
    ...
    - [Introduction à ASP.NET MVC (5 minutes)](how-do-i/5-minute-introduction-to-aspnet-mvc.md)
