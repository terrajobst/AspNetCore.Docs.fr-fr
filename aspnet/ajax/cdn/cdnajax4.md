...
ms.locfileid: "37364091"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="92f97-102">ASP.NET Web Forms et Ajax 4</span><span class="sxs-lookup"><span data-stu-id="92f97-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="92f97-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="92f97-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="92f97-104">Remarque : Les scripts de globalisation, telles que fr-FR.js, se trouve dans le dossier suivant :</span><span class="sxs-lookup"><span data-stu-id="92f97-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
