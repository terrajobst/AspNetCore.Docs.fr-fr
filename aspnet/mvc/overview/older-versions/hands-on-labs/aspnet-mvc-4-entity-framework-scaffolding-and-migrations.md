...
### <a name="exercise-1-using-aspnet-mvc-4-scaffolding-with-entity-framework-migrations"></a>Exercice 1 : À l’aide de la structure ASP.NET MVC 4 avec des Migrations Entity Framework
