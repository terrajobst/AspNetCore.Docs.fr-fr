...
> <span data-ttu-id="a689a-103">[Précédent - Ajouter un champ](new-field.md)
> [Suivant - Examiner les méthodes Details et Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="a689a-103">[Previous - Add a field](new-field.md)
