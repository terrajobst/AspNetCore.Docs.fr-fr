...
ms.locfileid: "41838643"
---
<a name="creating-a-site-wide-layout-using-master-pages-c"></a>Création d’une disposition de l’échelle du Site à l’aide de Pages maîtres (c#)
====================
...
**Figure 03**: fusion de la demande du balisage de Page dans la Page maître ([cliquez pour afficher l’image en taille réelle](creating-a-site-wide-layout-using-master-pages-cs/_static/image7.png))
...
**Figure 06**: la Page maître définit le balisage pour le haut, gauche et les parties de bas ([cliquez pour afficher l’image en taille réelle](creating-a-site-wide-layout-using-master-pages-cs/_static/image16.png))
