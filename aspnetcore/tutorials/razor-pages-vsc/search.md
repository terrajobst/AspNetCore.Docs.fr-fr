...
ms.locfileid: "31482673"
---
[!INCLUDE [Search](../../includes/RP/search.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="38ba7-103">[Précédent : Mise à jour des pages](xref:tutorials/razor-pages-vsc/da1)
> [Suivant : Ajout d’un nouveau champ](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="38ba7-103">[Previous: Updating the pages](xref:tutorials/razor-pages-vsc/da1)
