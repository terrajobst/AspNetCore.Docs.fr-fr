...
- [Guide de l’API](guide-to-the-api/index.md)
    ...
    - [Guide de l’API Hubs - Client JavaScript](guide-to-the-api/hubs-api-guide-javascript-client.md)
    - [Guide de l’API Hubs - Client .NET (C#)](guide-to-the-api/hubs-api-guide-net-client.md)
    - [Présentation et gestion des événements de durée de vie des connexions dans SignalR](guide-to-the-api/handling-connection-lifetime-events.md)
    - [Utilisation des groupes dans SignalR](guide-to-the-api/working-with-groups.md)
    - [Mappage des utilisateurs SignalR aux connexions](guide-to-the-api/mapping-users-to-connections.md)
- [Test et débogage](testing-and-debugging/index.md)
    ...
    - [Tests unitaires des applications SignalR](testing-and-debugging/unit-testing-signalr-applications.md)
    - [Activation du traçage SignalR](testing-and-debugging/enabling-signalr-tracing.md)
