...
<span data-ttu-id="3c1e7-103">[Précédent - Ajouter un modèle](adding-model.md)
[Suivant - Méthodes et vues du contrôleur](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="3c1e7-103">[Previous - Add a model](adding-model.md)
