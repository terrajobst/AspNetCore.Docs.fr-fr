...
---
<a name="using-ajax-control-toolkit-controls-and-control-extenders-vb"></a>À l’aide de contrôles AJAX Control Toolkit et extendeurs de contrôle (VB)
====================
...
**Figure 04**: option de tâche de l’extendeur ajouter ([cliquez pour afficher l’image en taille réelle](using-ajax-control-toolkit-controls-and-control-extenders-vb/_static/image8.png))
