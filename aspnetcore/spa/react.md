...
Si vous utilisez ASP.NET Core 2.0, vérifiez que vous avez [installé le modèle de projet React mis à jour](xref:spa/index#installation). Si vous avez ASP.NET Core 2.1, vous n’avez pas besoin de l’installer.
