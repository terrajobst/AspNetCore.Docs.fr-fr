...
ms.locfileid: "37833722"
---
<a name="aspnet-and-web-tools-for-visual-studio-2013-release-notes"></a>ASP.NET et Web Tools pour Visual Studio 2013 Release Notes de publication
====================
...
- Prise en charge pour la modification de l’onglet. Preivously, le **mettre le Document** commande, la mise en retrait automatique et auto mise en forme dans Visual Studio n’a pas fonctionné correctement lorsque vous utilisez le **conserver les tabulations** option. Cette modification résout Visual Studio pour le code Razor pour l’onglet mise en forme de mise en forme.
