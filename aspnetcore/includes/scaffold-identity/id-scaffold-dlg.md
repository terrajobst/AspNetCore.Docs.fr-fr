<span data-ttu-id="16544-101">Exécutez le Générateur de modèles automatique identité :</span><span class="sxs-lookup"><span data-stu-id="16544-101">Run the Identity scaffolder:</span></span>
