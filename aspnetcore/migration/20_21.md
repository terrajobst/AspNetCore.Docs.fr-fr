...
Un *framework partagé* est un ensemble d’assemblys (*.dll* fichiers) qui ne sont pas dans les dossiers de l’application. Le framework partagé doit être installé sur l’ordinateur pour exécuter l’application. Pour plus d’informations, consultez [framework partagé](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/).
