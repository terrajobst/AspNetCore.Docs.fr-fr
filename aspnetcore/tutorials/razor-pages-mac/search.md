...
<span data-ttu-id="9cfcd-103">[Précédent : Mise à jour des pages](xref:tutorials/razor-pages-mac/da1)
[Suivant : Ajout d’un nouveau champ](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="9cfcd-103">[Previous: Updating the pages](xref:tutorials/razor-pages-mac/da1)
