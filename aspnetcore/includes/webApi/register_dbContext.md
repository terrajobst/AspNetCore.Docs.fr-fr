## <a name="register-the-database-context"></a><span data-ttu-id="5aaa0-101">Inscrire le contexte de base de données</span><span class="sxs-lookup"><span data-stu-id="5aaa0-101">Register the database context</span></span>
