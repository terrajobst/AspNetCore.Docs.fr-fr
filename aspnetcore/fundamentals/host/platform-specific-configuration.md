...
1. Exécutez le script *deploy.ps1* du dossier *Deployment*. Le script ajoute :
   ...
   * Le chemin des dépendances d’hébergement au démarrage à la variable d’environnement `DOTNET_ADDITIONAL_DEPS`.
   * Le chemin du magasin de runtime à la variable d’environnement `DOTNET_SHARED_STORE`.
