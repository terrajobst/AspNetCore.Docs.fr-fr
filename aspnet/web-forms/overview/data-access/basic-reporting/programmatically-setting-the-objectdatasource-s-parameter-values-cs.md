...
ms.locfileid: "37827348"
---
<a name="programmatically-setting-the-objectdatasources-parameter-values-c"></a>Définition par programmation des valeurs de paramètre de l’ObjectDataSource (c#)
====================
...
**Figure 1**: The ObjectDataSource `Selected` et `Selecting` événements incendie avant et d’après son objet sous-jacent la méthode est appelée ([cliquez pour afficher l’image en taille réelle](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image3.png))
...
**Figure 10**: ceux employés dont anniversaires ce mois sont affichés ([cliquez pour afficher l’image en taille réelle](programmatically-setting-the-objectdatasource-s-parameter-values-cs/_static/image28.png))
