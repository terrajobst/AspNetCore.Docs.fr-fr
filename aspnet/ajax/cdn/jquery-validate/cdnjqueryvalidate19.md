...
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="f845d-102">jQuery.Validate version 1.9</span><span class="sxs-lookup"><span data-stu-id="f845d-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="f845d-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="f845d-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="f845d-104">Localisation des fichiers au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js où ## est le code de localisation.</span><span class="sxs-lookup"><span data-stu-id="f845d-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
