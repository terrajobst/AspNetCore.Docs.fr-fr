...
2. Ajouter une classe de démarrage OWIN. Dans Visual Studio 2013 cliquez avec le bouton droit sur le projet et sélectionnez **ajouter une classe**. - dans le **ajouter un nouvel élément** boîte de dialogue, entrez *OWIN* dans le champ de recherche, remplacez le nom par Startup.cs, puis cliquez sur **ajouter**.  
