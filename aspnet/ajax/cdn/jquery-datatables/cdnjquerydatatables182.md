...
ms.locfileid: "37817380"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="88e14-102">1.8.2 des DataTables jQuery</span><span class="sxs-lookup"><span data-stu-id="88e14-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="88e14-103">Les fichiers suivants pour le plug-ins de DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="88e14-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
