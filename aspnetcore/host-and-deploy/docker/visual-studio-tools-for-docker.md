...
[Visual Studio 2017](https://www.visualstudio.com/) prend en charge la création, le débogage et exécute des applications ciblant le .NET Core en conteneur ASP.NET Core. Les conteneurs Windows et Linux sont pris en charge.
...
Pour ajouter la prise en charge Docker à un projet ASP.NET Core, le projet doit cibler .NET Core. Les conteneurs Linux et Windows sont pris en charge.
