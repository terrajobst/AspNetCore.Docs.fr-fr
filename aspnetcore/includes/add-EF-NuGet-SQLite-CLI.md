<span data-ttu-id="7f94d-101">Exécutez les commandes CLI .NET Core suivantes :</span><span class="sxs-lookup"><span data-stu-id="7f94d-101">Run the following .NET Core CLI commands:</span></span>
