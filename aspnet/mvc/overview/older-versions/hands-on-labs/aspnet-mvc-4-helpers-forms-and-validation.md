...
1. [<span data-ttu-id="7b5a0-139">Création du contrôleur de Store Manager et sa vue Index</span><span class="sxs-lookup"><span data-stu-id="7b5a0-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
3. <span data-ttu-id="7b5a0-187">Dans la boîte de dialogue Ajouter une vue, vérifiez que le nom de la vue est **Index**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="7b5a0-188">Sélectionnez le **créer une vue fortement typée** option, puis sélectionnez **Album (MvcMusicStore.Models)** à partir de la **classe de modèle** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="7b5a0-189">Sélectionnez **liste** à partir de la **modèle de structure** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="7b5a0-190">Laissez le **moteur d’affichage** à **Razor** et les autres champs leur valeur par défaut de valeur, puis cliquez **ajouter**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="7b5a0-191">![Ajout d’une vue index](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "Ajout d’une vue d’index")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-191">![Adding an index view](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "Adding an index view")</span></span>
...
2. <span data-ttu-id="7b5a0-284">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-284">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-285">Remplacez l’URL par **/StoreManager/Edit/1** pour vérifier que les valeurs des propriétés de l’album passé sont affichés.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-285">Change the URL to **/StoreManager/Edit/1** to verify that the properties' values for the album passed are displayed.</span></span>
    ...
    <span data-ttu-id="7b5a0-286">![Parcourir la vue de modification d’Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image8.png "parcourir la vue de modification d’Album")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-286">![Browsing Album's Edit View](aspnet-mvc-4-helpers-forms-and-validation/_static/image8.png "Browsing Album's Edit View")</span></span>
...
1. <span data-ttu-id="7b5a0-297">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-297">Press **F5** to run the Application.</span></span>
...
<span data-ttu-id="7b5a0-347">Dans cette tâche, vous allez ajouter le modèle de créer une vue qui affiche un nouveau formulaire d’Album (vide).</span><span class="sxs-lookup"><span data-stu-id="7b5a0-347">In this task, you will add the Create View template that will display a new (empty) Album form.</span></span>
...
2. <span data-ttu-id="7b5a0-359">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-359">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-360">Remplacez l’URL par **/StoreManager/créer**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-360">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="7b5a0-361">Vérifiez qu’un formulaire vide s’affiche pour remplir les nouvelles propriétés de l’Album.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-361">Verify that an empty form is displayed for filling the new Album properties.</span></span>
    ...
    <span data-ttu-id="7b5a0-362">![Créer une vue avec un formulaire vide](aspnet-mvc-4-helpers-forms-and-validation/_static/image12.png "créer une vue avec un formulaire vide")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-362">![Create View with an empty form](aspnet-mvc-4-helpers-forms-and-validation/_static/image12.png "Create View with an empty form")</span></span>
...
1. <span data-ttu-id="7b5a0-392">Ouvrez le **commencer** solution situé dans **/Ex5-HandlingDeletion/début du fichierSource/** dossier.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-392">Open the **Begin** solution located at **Source/Ex5-HandlingDeletion/Begin/** folder.</span></span> <span data-ttu-id="7b5a0-393">Sinon, vous pouvez continuer à utiliser le **fin** solution obtenu par le biais de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-393">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>
   ...
   3. <span data-ttu-id="7b5a0-397">Enfin, générez la solution en cliquant sur **Build** | **générer la Solution**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-397">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>
      ...
      > [!NOTE]
      > <span data-ttu-id="7b5a0-398">Un des avantages de l’utilisation de NuGet est que vous n’êtes pas obligé expédier toutes les bibliothèques dans votre projet, ce qui réduit la taille du projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-398">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="7b5a0-399">Avec NuGet Power Tools, en spécifiant les versions de package dans le fichier Packages.config, vous serez en mesure de télécharger toutes les bibliothèques nécessaires à la première fois que vous exécutez le projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-399">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="7b5a0-400">C’est pourquoi vous devrez exécuter ces étapes après avoir ouvert une solution existante à partir de ce laboratoire.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-400">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="7b5a0-401">Ouvrez **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-401">Open **StoreManagerController** class.</span></span> <span data-ttu-id="7b5a0-402">Pour ce faire, développez le **contrôleurs** dossier et double-cliquez sur **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-402">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
3. <span data-ttu-id="7b5a0-403">L’action de contrôleur de suppression est exactement le même que l’action de contrôleur Store détails précédente : elle interroge le **album** objet à partir de la base de données à l’aide de la **id** fourni dans l’URL et retourne le appropriée **vue**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="7b5a0-404">Pour ce faire, remplacez la HTTP-GET **supprimer** code de méthode d’action avec les éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>

    <span data-ttu-id="7b5a0-405">(Code Snippet - *programmes d’assistance ASP.NET MVC 4 et de formulaires et de Validation - action Ex5 gestion suppression HTTP-GET Delete*)</span><span class="sxs-lookup"><span data-stu-id="7b5a0-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample15.cs)]
4. <span data-ttu-id="7b5a0-406">Avec le bouton droit à l’intérieur de la **supprimer** méthode d’action, puis **ajouter une vue**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-406">Right-click inside the **Delete** action method and select **Add View**.</span></span> <span data-ttu-id="7b5a0-407">Cela fera apparaître la boîte de dialogue Ajouter une vue.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-407">This will bring up the Add View dialog.</span></span>
5. <span data-ttu-id="7b5a0-408">Dans la boîte de dialogue Ajouter une vue, vérifiez que le nom de la vue est **supprimer**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="7b5a0-409">Sélectionnez le **créer une vue fortement typée** option et sélectionnez **Album (MvcMusicStore.Models)** à partir de la **classe de modèle** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="7b5a0-410">Sélectionnez **supprimer** à partir de la **modèle de structure** liste déroulante.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="7b5a0-411">Laissez les autres champs avec leur valeur par défaut, puis **ajouter**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="7b5a0-412">![Ajout d’une vue Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Ajout d’une vue de la suppression")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="7b5a0-413">*Ajout d’une vue de la suppression*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="7b5a0-414">Le modèle de suppression affiche tous les champs à partir du modèle.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="7b5a0-415">Vous afficherez uniquement les titre d’album.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-415">You will show only the album's title.</span></span> <span data-ttu-id="7b5a0-416">Pour ce faire, remplacez le contenu de la vue par le code suivant :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="7b5a0-417">Tâche 2 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="7b5a0-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="7b5a0-418">Dans cette tâche, vous allez tester que le **StoreManager** **supprimer** afficher la page affiche un formulaire de suppression de confirmation.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="7b5a0-419">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="7b5a0-420">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-420">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-421">Remplacez l’URL par **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="7b5a0-422">Sélectionnez un album à supprimer en cliquant sur **supprimer** et vérifiez que la nouvelle vue est téléchargée.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="7b5a0-423">![Suppression d’un Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "suppression d’un Album")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="7b5a0-424">*Suppression d’un Album*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="7b5a0-425">Tâche 3-implémentation de la méthode d’Action Delete HTTP-POST</span><span class="sxs-lookup"><span data-stu-id="7b5a0-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="7b5a0-426">Dans cette tâche, vous allez implémenter la version de HTTP-POST de la méthode d’action Delete qui est appelée lorsqu’un utilisateur clique sur le **supprimer** bouton.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="7b5a0-427">La méthode doit supprimer l’album dans la base de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="7b5a0-428">Fermez le navigateur si nécessaire, pour revenir à la fenêtre Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="7b5a0-429">Ouvrez **StoreManagerController** classe.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="7b5a0-430">Pour ce faire, développez le **contrôleurs** dossier et double-cliquez sur **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="7b5a0-431">Remplacez **HTTP-POST et Delete** code de méthode d’action avec les éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="7b5a0-432">(Code Snippet - *programmes d’assistance ASP.NET MVC 4 et de formulaires et de Validation - action Ex5 gestion suppression HTTP-POST et Delete*)</span><span class="sxs-lookup"><span data-stu-id="7b5a0-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="7b5a0-433">Tâche 4 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="7b5a0-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="7b5a0-434">Dans cette tâche, vous allez tester que le **StoreManager Delete** page de vue vous permet de supprimer un Album, il redirige vers la vue Index StoreManager.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="7b5a0-435">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="7b5a0-436">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-436">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-437">Remplacez l’URL par **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="7b5a0-438">Sélectionnez un album à supprimer en cliquant sur **supprimer.**</span><span class="sxs-lookup"><span data-stu-id="7b5a0-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="7b5a0-439">Confirmer la suppression en cliquant sur **supprimer** bouton :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="7b5a0-440">![Suppression d’un Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "suppression d’un Album")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="7b5a0-441">*Suppression d’un Album*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="7b5a0-442">Vérifiez que l’album a été supprimée, car il n’apparaît pas dans le **Index** page.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="7b5a0-443">Exercice 6 : Ajout de la Validation</span><span class="sxs-lookup"><span data-stu-id="7b5a0-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="7b5a0-444">Actuellement, les formulaires de créer et modifier en place sans effectuer n’importe quel type de validation.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="7b5a0-445">Si l’utilisateur quitte un champ obligatoire vide ou les lettres de type dans le champ de prix, la première erreur, que vous obtenez sera effectué depuis la base de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="7b5a0-446">Vous pouvez ajouter la validation à l’application en ajoutant des Annotations de données à votre classe de modèle.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="7b5a0-447">Annotations de données décrivant les règles appliquées aux propriétés de votre modèle et de ASP.NET MVC s’occupera de l’application et afficher le message approprié pour les utilisateurs.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="7b5a0-448">Tâche 1 : ajouter des Annotations de données</span><span class="sxs-lookup"><span data-stu-id="7b5a0-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="7b5a0-449">Dans cette tâche, vous allez ajouter des Annotations de données au modèle Album qui rend la page Create et Edit affiche des messages de validation lorsque cela est approprié.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="7b5a0-450">Pour une classe de modèle simple, ajout d’une Annotation de données est uniquement géré en ajoutant un **à l’aide de** instruction pour **System.ComponentModel.DataAnnotation**, puis placer un **[obligatoire]** attribut sur les propriétés appropriées.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="7b5a0-451">L’exemple suivant rendrait la **nom** propriété un champ obligatoire dans la vue.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="7b5a0-452">Il s’agit un peu plus complexe dans les cas de cette application où l’Entity Data Model est généré.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="7b5a0-453">Si vous avez ajouté des Annotations de données directement sur les classes de modèle, ils seront remplacées si vous mettez à jour le modèle à partir de la base de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="7b5a0-454">Au lieu de cela, vous pouvez rendre l’utilisation des métadonnées des classes partielles qui existera pour contenir les annotations et sont associées avec le modèle de classes à l’aide de la **[MetadataType]** attribut.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="7b5a0-455">Ouvrez le **commencer** solution situé dans **/Ex6-AddingValidation/début du fichierSource/** dossier.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="7b5a0-456">Sinon, vous pouvez continuer à utiliser le **fin** solution obtenu par le biais de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="7b5a0-457">Si vous avez ouvert le fourni **commencer** solution, vous devrez télécharger certains packages NuGet manquants avant de continuer.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="7b5a0-458">Pour ce faire, cliquez sur le **projet** menu et sélectionnez **gérer les Packages NuGet**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="7b5a0-459">Dans le **gérer les Packages NuGet** boîte de dialogue, cliquez sur **restaurer** afin de télécharger les packages manquants.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="7b5a0-460">Enfin, générez la solution en cliquant sur **Build** | **générer la Solution**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="7b5a0-461">Un des avantages de l’utilisation de NuGet est que vous n’êtes pas obligé expédier toutes les bibliothèques dans votre projet, ce qui réduit la taille du projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="7b5a0-462">Avec NuGet Power Tools, en spécifiant les versions de package dans le fichier Packages.config, vous serez en mesure de télécharger toutes les bibliothèques nécessaires à la première fois que vous exécutez le projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="7b5a0-463">C’est pourquoi vous devrez exécuter ces étapes après avoir ouvert une solution existante à partir de ce laboratoire.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="7b5a0-464">Ouvrez le **Album.cs** à partir de la **modèles** dossier.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="7b5a0-465">Remplacez **Album.cs** de contenu avec le code en surbrillance, afin qu’il ressemble à ceci :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="7b5a0-466">La ligne **[DisplayFormat(ConvertEmptyStringToNull=false)]** indique que des chaînes vides à partir du modèle ne sont pas être converties en valeurs null lorsque le champ de données est mis à jour dans la source de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="7b5a0-467">Ce paramètre permet d’éviter une exception lorsqu’Entity Framework attribue des valeurs null pour le modèle avant de l’Annotation de données valide les champs.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="7b5a0-468">(Code Snippet - *programmes d’assistance ASP.NET MVC 4 et de formulaires et de Validation - classe partielle de métadonnées Ex6 Album*)</span><span class="sxs-lookup"><span data-stu-id="7b5a0-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="7b5a0-469">Cela **Album** classe partielle a une **MetadataType** attribut qui pointe vers le **AlbumMetaData** classe pour les Annotations de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="7b5a0-470">Voici certains des attributs d’Annotation de données que vous utilisez pour annoter le modèle d’Album :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="7b5a0-471">Obligatoire - indique que la propriété est un champ obligatoire</span><span class="sxs-lookup"><span data-stu-id="7b5a0-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="7b5a0-472">DisplayName : définit le texte à utiliser sur les champs de formulaire et les messages de validation</span><span class="sxs-lookup"><span data-stu-id="7b5a0-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="7b5a0-473">DisplayFormat - Spécifie le mode d’affichage et de mise en forme des champs de données.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="7b5a0-474">StringLength - définit une longueur maximale pour un champ de chaîne</span><span class="sxs-lookup"><span data-stu-id="7b5a0-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="7b5a0-475">Plage - donne la valeur minimale et maximale pour un champ numérique</span><span class="sxs-lookup"><span data-stu-id="7b5a0-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="7b5a0-476">ScaffoldColumn - permet de masquer des champs de formulaires de l’éditeur</span><span class="sxs-lookup"><span data-stu-id="7b5a0-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="7b5a0-477">Tâche 2 : exécution de l’Application</span><span class="sxs-lookup"><span data-stu-id="7b5a0-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="7b5a0-478">Dans cette tâche, vous allez tester les pages Create et Edit valident des champs, en utilisant les noms d’affichage choisis dans la dernière tâche.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="7b5a0-479">Appuyez sur **F5** pour exécuter l’Application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="7b5a0-480">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-480">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-481">Remplacez l’URL par **/StoreManager/créer**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="7b5a0-482">Vérifiez que les noms d’affichage correspondent à celles de la classe partielle (tels que **Album Art URL** au lieu de **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="7b5a0-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="7b5a0-483">Cliquez sur **créer**, sans le remplir le formulaire.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="7b5a0-484">Vérifiez que vous obtenez les messages de validation correspondants.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="7b5a0-485">![Validé des champs dans la page Create](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "validé des champs dans la page Create")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="7b5a0-486">*Champs validés dans la page Create*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="7b5a0-487">Vous pouvez vérifier que s’applique également à la **modifier** page.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="7b5a0-488">Remplacez l’URL par **/StoreManager/Edit/1** et vérifiez que les noms d’affichage correspondent à celles de la classe partielle (tels que **Album Art URL** au lieu de **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="7b5a0-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="7b5a0-489">Vide le **titre** et **prix** champs et cliquez sur **enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="7b5a0-490">Vérifiez que vous obtenez les messages de validation correspondants.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-490">Verify that you get the corresponding validation messages.</span></span>

    ![Champs validés dans la page de modification](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="7b5a0-492">*Champs validés dans la page de modification*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="7b5a0-493">Exercice 7 : À l’aide de jQuery non obstructive côté Client</span><span class="sxs-lookup"><span data-stu-id="7b5a0-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="7b5a0-494">Dans cet exercice, vous allez apprendre à activer MVC 4 Unobtrusive validation jQuery côté client.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="7b5a0-495">Le jQuery non obstructive utilise le préfixe de données-ajax JavaScript pour appeler des méthodes d’action sur le serveur et non intrusive émettant les scripts client.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="7b5a0-496">Tâche 1 : exécution de l’Application avant l’activation non obstructive jQuery</span><span class="sxs-lookup"><span data-stu-id="7b5a0-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="7b5a0-497">Dans cette tâche, vous allez exécuter l’application avant d’inclure jQuery pour comparer les deux modèles de validation.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="7b5a0-498">Ouvrez le **commencer** solution situé dans **/Ex7-UnobtrusivejQueryValidation/début du fichierSource/** dossier.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="7b5a0-499">Sinon, vous pouvez continuer à utiliser le **fin** solution obtenu par le biais de l’exercice précédent.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="7b5a0-500">Si vous avez ouvert le fourni **commencer** solution, vous devrez télécharger certains packages NuGet manquants avant de continuer.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="7b5a0-501">Pour ce faire, cliquez sur le **projet** menu et sélectionnez **gérer les Packages NuGet**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="7b5a0-502">Dans le **gérer les Packages NuGet** boîte de dialogue, cliquez sur **restaurer** afin de télécharger les packages manquants.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="7b5a0-503">Enfin, générez la solution en cliquant sur **Build** | **générer la Solution**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="7b5a0-504">Un des avantages de l’utilisation de NuGet est que vous n’êtes pas obligé expédier toutes les bibliothèques dans votre projet, ce qui réduit la taille du projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="7b5a0-505">Avec NuGet Power Tools, en spécifiant les versions de package dans le fichier Packages.config, vous serez en mesure de télécharger toutes les bibliothèques nécessaires à la première fois que vous exécutez le projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="7b5a0-506">C’est pourquoi vous devrez exécuter ces étapes après avoir ouvert une solution existante à partir de ce laboratoire.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="7b5a0-507">Appuyez sur **F5** pour exécuter l’application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="7b5a0-508">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-508">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-509">Parcourir **/StoreManager/créer** et cliquez sur **créer** sans remplir le formulaire pour vérifier que vous obtenez des messages de validation :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="7b5a0-510">![Validation côté client désactivée](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "validation côté Client désactivée")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="7b5a0-511">*Validation côté client désactivée*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="7b5a0-512">Dans le navigateur, ouvrez le code source HTML :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="7b5a0-513">Tâche 2 - Validation de Client non obstructive l’activation</span><span class="sxs-lookup"><span data-stu-id="7b5a0-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="7b5a0-514">Dans cette tâche, vous allez activer jQuery **validation client non obstructive** de **Web.config** fichier, qui est définie sur false dans tous les nouveaux projets ASP.NET MVC 4 par défaut.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="7b5a0-515">En outre, vous allez ajouter de que références pour rendre le travail de Validation Client discrète de jQuery les scripts nécessaires.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="7b5a0-516">Ouvrez **Web.Config** de fichiers à la racine du projet et vous assurer que le **ClientValidationEnabled** et **UnobtrusiveJavaScriptEnabled** les valeurs de clés sont définies sur **true**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="7b5a0-517">Vous pouvez également activer la validation côté client par le code à Global.asax.cs pour obtenir les mêmes résultats :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="7b5a0-518">**HtmlHelper.ClientValidationEnabled = true ;**</span><span class="sxs-lookup"><span data-stu-id="7b5a0-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="7b5a0-519">En outre, vous pouvez affecter ClientValidationEnabled attribut dans n’importe quel contrôleur pour avoir un comportement personnalisé.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="7b5a0-520">Ouvrez **Create.cshtml** à **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="7b5a0-521">Assurez-vous que les fichiers de script suivant, **jquery.validate** et **jquery.validate.unobtrusive**, sont référencées dans la vue les invites le &quot; **~/bundles/jqueryval** &quot; offre groupée.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="7b5a0-522">Toutes ces bibliothèques jQuery sont inclus dans les nouveaux projets de MVC 4.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="7b5a0-523">Vous trouverez d’autres bibliothèques dans le **/Scripts** dossier de votre projet.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="7b5a0-524">Pour effectuer cette validation bibliothèques fonctionnent, vous devez ajouter une référence à la bibliothèque de framework de jQuery.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="7b5a0-525">Étant donné que cette référence est déjà ajoutée dans le  **\_Layout.cshtml** fichier, vous n’avez pas besoin de l’ajouter dans cette vue particulière.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="7b5a0-526">Tâche 3 : l’Application à l’aide de discrète jQuery Validation en cours d’exécution</span><span class="sxs-lookup"><span data-stu-id="7b5a0-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="7b5a0-527">Dans cette tâche, vous allez tester que le **StoreManager** créer la vue modèle effectue la validation côté client à l’aide des bibliothèques de jQuery lorsque l’utilisateur crée un nouvel album.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="7b5a0-528">Appuyez sur **F5** pour exécuter l’application.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="7b5a0-529">Le projet démarre dans la page d’accueil.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-529">The project starts in the Home page.</span></span> <span data-ttu-id="7b5a0-530">Parcourir **/StoreManager/créer** et cliquez sur **créer** sans remplir le formulaire pour vérifier que vous obtenez des messages de validation :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="7b5a0-531">![Validation côté client avec jQuery activé](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "validation côté Client avec jQuery activé")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="7b5a0-532">*Validation côté client avec jQuery activé*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="7b5a0-533">Dans le navigateur, ouvrez le code source pour créer une vue :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="7b5a0-534">Pour chaque règle de validation client jQuery non obstructive ajoute un attribut avec des données-val -*rulename*=&quot;*message*&quot;.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="7b5a0-535">Voici une liste de balises que discrète jQuery insère dans le champ d’entrée html pour effectuer la validation côté client :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="7b5a0-536">Données-val</span><span class="sxs-lookup"><span data-stu-id="7b5a0-536">Data-val</span></span>
   > - <span data-ttu-id="7b5a0-537">Numéro de données val</span><span class="sxs-lookup"><span data-stu-id="7b5a0-537">Data-val-number</span></span>
   > - <span data-ttu-id="7b5a0-538">Plage de données val</span><span class="sxs-lookup"><span data-stu-id="7b5a0-538">Data-val-range</span></span>
   > - <span data-ttu-id="7b5a0-539">Données-val-range-min / données-val-range-max</span><span class="sxs-lookup"><span data-stu-id="7b5a0-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="7b5a0-540">Données val requises</span><span class="sxs-lookup"><span data-stu-id="7b5a0-540">Data-val-required</span></span>
   > - <span data-ttu-id="7b5a0-541">Longueur des données-val</span><span class="sxs-lookup"><span data-stu-id="7b5a0-541">Data-val-length</span></span>
   > - <span data-ttu-id="7b5a0-542">Données-val-longueur-max / données val-Longueur-min.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="7b5a0-543">Toutes les valeurs de données sont remplis avec modèle **Annotation de données**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="7b5a0-544">Ensuite, toute la logique qui fonctionne au côté serveur peut être exécutée côté client.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="7b5a0-545">Par exemple, attribut prix a l’annotation de données suivante dans le modèle :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="7b5a0-546">Après avoir utilisé jQuery non obstructive, le code généré est :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="7b5a0-547">Récapitulatif</span><span class="sxs-lookup"><span data-stu-id="7b5a0-547">Summary</span></span>

<span data-ttu-id="7b5a0-548">En fin de cet atelier pratique, que vous savez comment permettre aux utilisateurs de modifier les données stockées dans la base de données à l’aide des éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="7b5a0-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="7b5a0-549">Actions de contrôleur comme Index, Create, Edit, Delete</span><span class="sxs-lookup"><span data-stu-id="7b5a0-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="7b5a0-550">Fonctionnalité de génération de modèles automatique de ASP.NET MVC pour l’affichage des propriétés dans un tableau HTML</span><span class="sxs-lookup"><span data-stu-id="7b5a0-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="7b5a0-551">Expérience de programmes d’assistance HTML personnalisées afin d’améliorer l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="7b5a0-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="7b5a0-552">Méthodes d’action qui réagissent aux HTTP-GET ou d’appels HTTP-POST</span><span class="sxs-lookup"><span data-stu-id="7b5a0-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="7b5a0-553">Un modèle d’éditeur partagé pour les modèles de vue similaires telles que Create et Edit</span><span class="sxs-lookup"><span data-stu-id="7b5a0-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="7b5a0-554">Éléments de formulaire tels que des listes déroulantes</span><span class="sxs-lookup"><span data-stu-id="7b5a0-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="7b5a0-555">Annotations de données pour la validation de modèle</span><span class="sxs-lookup"><span data-stu-id="7b5a0-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="7b5a0-556">Validation côté client à l’aide de la bibliothèque jQuery non obstructive</span><span class="sxs-lookup"><span data-stu-id="7b5a0-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="7b5a0-557">Annexe a : installation de Visual Studio Express 2012 pour le Web</span><span class="sxs-lookup"><span data-stu-id="7b5a0-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="7b5a0-558">Vous pouvez installer **Microsoft Visual Studio Express 2012 pour Web** ou un autre &quot;Express&quot; à l’aide de la version du **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="7b5a0-559">Les instructions suivantes vous guident dans les étapes requises pour installer *Visual studio Express 2012 pour Web* à l’aide de *Microsoft Web Platform Installer*.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="7b5a0-560">Accédez à [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="7b5a0-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="7b5a0-561">Si vous avez déjà installé Web Platform Installer, vous pouvez également ouvrir il et recherchez le produit &quot; <em>Visual Studio Express 2012 pour le Web avec Windows Azure SDK</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="7b5a0-562">Cliquez sur **installer maintenant**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-562">Click on **Install Now**.</span></span> <span data-ttu-id="7b5a0-563">Si vous n’avez pas **Web Platform Installer** vous allez être redirigé pour télécharger et installer en premier.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="7b5a0-564">Une fois **Web Platform Installer** est ouvert, cliquez sur **installer** pour démarrer le programme d’installation.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="7b5a0-565">![Installer Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "installer Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="7b5a0-566">*Installer Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="7b5a0-567">Lisez les licences et les termes du contrat de tous les produits et cliquez sur **J’accepte** pour continuer.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Accepter les termes du contrat de licence](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="7b5a0-569">*Accepter les termes du contrat de licence*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="7b5a0-570">Attendez que le processus de téléchargement et l’installation se termine.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-570">Wait until the downloading and installation process completes.</span></span>

    ![Progression de l'installation](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="7b5a0-572">*Progression de l’installation*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-572">*Installation progress*</span></span>
6. <span data-ttu-id="7b5a0-573">Une fois l’installation terminée, cliquez sur **Terminer**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-573">When the installation completes, click **Finish**.</span></span>

    ![Installation est terminée](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="7b5a0-575">*Installation est terminée*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-575">*Installation completed*</span></span>
7. <span data-ttu-id="7b5a0-576">Cliquez sur **Exit** pour fermer Web Platform Installer.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="7b5a0-577">Pour ouvrir Visual Studio Express pour le Web, accédez à la **Démarrer** écran et démarrer l’écriture &quot; **VS Express**&quot;, puis cliquez sur le **Visual Studio Express pour le Web** vignette.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express pour une vignette de Web](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="7b5a0-579">*VS Express pour une vignette de Web*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="7b5a0-580">Annexe b : utilisation d’extraits de Code</span><span class="sxs-lookup"><span data-stu-id="7b5a0-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="7b5a0-581">Avec des extraits de code, vous avez tout le code que vous avez besoin à portée de main.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="7b5a0-582">Le document de laboratoire vous indiquera exactement quand vous pouvez les utiliser, comme indiqué dans l’illustration suivante.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="7b5a0-583">![À l’aide d’extraits de code Visual Studio pour insérer du code dans votre projet](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "extraits de code à l’aide de Visual Studio pour insérer du code dans votre projet")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="7b5a0-584">*À l’aide d’extraits de code Visual Studio pour insérer du code dans votre projet*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="7b5a0-585">***Pour ajouter un extrait de code à l’aide du clavier (c# uniquement)***</span><span class="sxs-lookup"><span data-stu-id="7b5a0-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="7b5a0-586">Placez le curseur où vous souhaitez insérer le code.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="7b5a0-587">Commencez à taper le nom de l’extrait de code (sans espaces ou des traits d’union).</span><span class="sxs-lookup"><span data-stu-id="7b5a0-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="7b5a0-588">Regarder en tant qu’IntelliSense affiche les noms des extraits correspondants.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="7b5a0-589">Sélectionnez l’extrait de code correct (ou continuez à taper jusqu'à ce que le nom de l’extrait de code entière est sélectionnée).</span><span class="sxs-lookup"><span data-stu-id="7b5a0-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="7b5a0-590">Appuyez sur la touche Tab à deux reprises pour insérer l’extrait de code à l’emplacement du curseur.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="7b5a0-591">![Commencez à taper le nom de l’extrait de code](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "commencez à taper le nom de l’extrait de code")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="7b5a0-592">*Commencez à taper le nom de l’extrait de code*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="7b5a0-593">![Appuyez sur Tab pour sélectionner l’extrait de code en surbrillance](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "appuyez sur Tab pour sélectionner l’extrait de code en surbrillance")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="7b5a0-594">*Appuyez sur Tab pour sélectionner l’extrait de code en surbrillance*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="7b5a0-595">![Appuyez sur Tab à nouveau et l’extrait de code seront développe](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "appuyez sur Tab à nouveau et l’extrait de code seront développe.")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="7b5a0-596">*Appuyez sur Tab à nouveau et l’extrait de code seront développe.*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="7b5a0-597">***Pour ajouter un extrait de code à l’aide de la souris (c#, Visual Basic et XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="7b5a0-598">Avec le bouton droit dans laquelle vous souhaitez insérer l’extrait de code.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="7b5a0-599">Sélectionnez **insérer un extrait** suivie **mes extraits de Code**.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="7b5a0-600">Choisissez l’extrait de code approprié dans la liste, en cliquant dessus.</span><span class="sxs-lookup"><span data-stu-id="7b5a0-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="7b5a0-601">![Avec le bouton droit dans laquelle vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "avec le bouton droit dans laquelle vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="7b5a0-602">*Avec le bouton droit dans laquelle vous souhaitez insérer l’extrait de code et sélectionnez Insérer un extrait*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="7b5a0-603">![Choisissez l’extrait de code approprié dans la liste, en cliquant dessus](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "choisir l’extrait de code approprié dans la liste, en cliquant sur celle-ci")</span><span class="sxs-lookup"><span data-stu-id="7b5a0-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="7b5a0-604">*Choisissez l’extrait de code approprié dans la liste, en cliquant sur celle-ci*</span><span class="sxs-lookup"><span data-stu-id="7b5a0-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
