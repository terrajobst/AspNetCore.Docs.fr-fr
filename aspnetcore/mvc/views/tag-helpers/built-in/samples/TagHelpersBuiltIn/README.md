# <a name="aspnet-core-built-in-tag-helpers-sample"></a>Exemple de Tag Helpers intégrés ASP.NET Core

Cet exemple illustre les variations des Tag Helpers intégrés avec MVC et Razor Pages :

- [Tag Helper d’ancre](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/anchor-tag-helper)
...
- [Tag Helper Ppartial](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/partial-tag-helper)
