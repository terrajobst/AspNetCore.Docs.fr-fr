...
ms.locfileid: "37401107"
---
<a name="jquery-validation-1130"></a><span data-ttu-id="06d05-102">jQuery Validation 1.13.0</span><span class="sxs-lookup"><span data-stu-id="06d05-102">jQuery Validation 1.13.0</span></span>
====================
<span data-ttu-id="06d05-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="06d05-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="06d05-104">Localisation des fichiers au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js où ## est le code de localisation.</span><span class="sxs-lookup"><span data-stu-id="06d05-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
