...
---
<a name="adding-a-new-category-to-the-dropdownlist-using-jquery-ui"></a>Ajout d’une nouvelle catégorie au contrôle DropDownList à l’aide de l’interface utilisateur jQuery
====================
