...
**Figure 1**: liaison de données obtenue en effectuant un appel AJAX asynchrone à un Service Web.  ([Cliquez pour afficher l’image en taille réelle](understanding-asp-net-ajax-web-services/_static/image3.png))
