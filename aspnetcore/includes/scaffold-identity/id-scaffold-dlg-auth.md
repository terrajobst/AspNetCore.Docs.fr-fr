<span data-ttu-id="08979-101">Exécutez le Générateur de modèles automatique identité :</span><span class="sxs-lookup"><span data-stu-id="08979-101">Run the Identity scaffolder:</span></span>
