<span data-ttu-id="b0024-101">Ajoutez les propriétés suivantes à la classe `Movie` :</span><span class="sxs-lookup"><span data-stu-id="b0024-101">Add the following properties to the `Movie` class:</span></span>
