...
- API web ASP.NET
- Modèles de projet par défaut actualisées et modernes
...
### <a name="install-aspnet-mvc-4-for-visual-studio-2010"></a>Installez ASP.NET MVC 4 pour Visual Studio 2010

- Télécharger la version autonome ASP.NET [programme d’installation exécutable de MVC 4](https://www.microsoft.com/download/details.aspx?id=30683)


### <a name="install-visual-studio-2012-includes-aspnet-mvc-4"></a>Installer Visual Studio 2012 (y compris ASP.NET MVC 4)
...
- Obtenir de l’aide et de discuter de ASP.NET MVC 4 dans le [forums](https://forums.asp.net/1146.aspx)
