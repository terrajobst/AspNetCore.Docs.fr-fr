...
---
<a name="creating-a-custom-ajax-control-toolkit-control-extender-vb"></a>Création d’un extendeur de contrôle de boîte à outils de contrôle AJAX personnalisée (VB)
====================
...
- DisabledButtonDesigner.vb - cette classe permet à des fonctionnalités au moment du design. Vous avez besoin de cette classe si vous souhaitez que l’extendeur du contrôle pour fonctionner correctement avec le Concepteur de développeur Visual Studio/Visual Web.
...
**Figure 05**: boîte de dialogue de l’Assistant d’extendeur ([cliquez pour afficher l’image en taille réelle](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image21.png))
...
**Figure 07**: The DisabledButton l’extendeur en action ([cliquez pour afficher l’image en taille réelle](creating-a-custom-ajax-control-toolkit-control-extender-vb/_static/image27.png))
