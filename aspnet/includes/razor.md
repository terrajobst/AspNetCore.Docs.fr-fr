Une version mise à jour de ce didacticiel est disponible [ici](https://docs.microsoft.com/aspnet/core/tutorials/first-mvc-app/start-mvc) à l’aide de la dernière version de [Visual Studio.](https://www.visualstudio.com) Utilise le nouveau didacticiel [ASP.NET Core MVC](https://docs.microsoft.com/aspnet/core/mvc/), qui fournit **nombreux** améliorations par rapport à ce didacticiel.
