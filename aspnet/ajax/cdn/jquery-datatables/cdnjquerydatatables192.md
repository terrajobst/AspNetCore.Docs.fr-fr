...
title: 1.9.2 des DataTables jQuery | Microsoft Docs
...
ms.locfileid: "37824132"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="2003f-102">1.9.2 des DataTables jQuery</span><span class="sxs-lookup"><span data-stu-id="2003f-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="2003f-103">Les fichiers suivants pour le plug-ins de DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="2003f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
