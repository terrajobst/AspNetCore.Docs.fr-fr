## <a name="register-the-database-context"></a><span data-ttu-id="ca12a-101">Inscrire le contexte de base de données</span><span class="sxs-lookup"><span data-stu-id="ca12a-101">Register the database context</span></span>
