...
**Figure 6**: ajouter les contrôles Web différents à la `CreatingUserAccounts.aspx Page` ([cliquez pour afficher l’image en taille réelle](creating-user-accounts-vb/_static/image18.png))
...
**Figure 12**: le contrôle CreateUserWizard automatiquement injecte les contrôles de Validation ([cliquez pour afficher l’image en taille réelle](creating-user-accounts-vb/_static/image36.png))
