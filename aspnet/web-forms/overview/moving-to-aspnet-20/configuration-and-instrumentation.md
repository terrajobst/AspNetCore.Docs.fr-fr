...
| **Mise en mémoire tampon** | Utilisé avec les fournisseurs de messagerie et de SQL Server pour déterminer la fréquence à laquelle les événements de vidage au fournisseur. |
...
## <a name="lab-2-logging-application-restarts"></a>Atelier 2 : Journalisation redémarrage de l’Application
