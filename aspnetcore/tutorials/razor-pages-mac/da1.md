...
<span data-ttu-id="90c23-103">[Précédent : Utilisation de SQLite](xref:tutorials/razor-pages-mac/sql)
[Ajout d’une fonction de recherche](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="90c23-103">[Previous: Working with SQLlite](xref:tutorials/razor-pages-mac/sql)
