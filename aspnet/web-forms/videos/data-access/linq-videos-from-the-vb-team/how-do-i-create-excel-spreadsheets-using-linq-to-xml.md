...
---
<a name="how-do-i-create-excel-spreadsheets-using-linq-to-xml"></a>[Comment faire] Créer des feuilles de calcul Excel à l’aide de LINQ to XML ?
====================
par [Beth Massi](https://github.com/bethmassi)

Les développeurs Visual Basic apprendrez comment interroger la base de données SQL Server afin de créer facilement des feuilles de calcul Excel directement dans l’éditeur de Visual Basic à l’aide de LINQ to XML.

[&#9654;Regardez la vidéo (10 minutes)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-create-excel-spreadsheets-using-linq-to-xml)

> [!div class="step-by-step"]
> [Précédent](how-do-i-create-xml-documents-from-sql-data.md)
