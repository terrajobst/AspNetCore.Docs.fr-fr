...
Gérer les erreurs à l’aide d’une instruction try-catch. Inspectez l’objet `Exception` pour déterminer l’action appropriée à entreprendre après une erreur.
