...
**Figure 2**: le contrôle DetailsView contrôle affiche un seul produit à la fois ([cliquez pour afficher l’image en taille réelle](custom-formatting-based-upon-data-vb/_static/image6.png))


## <a name="step-2-programmatically-determining-the-value-of-the-data-in-the-databound-event-handler"></a>Étape 2 : Déterminer par programmation la valeur des données dans le Gestionnaire d’événement DataBound
...
> [!NOTE]
> Vous pouvez également créer un gestionnaire d’événements à partir de la partie du code de la page ASP.NET. Vous y trouverez deux listes déroulantes en haut de la page. Sélectionnez l’objet dans la liste déroulante de gauche et l’événement que vous souhaitez créer un gestionnaire pour à partir de la liste déroulante de droite et Visual Studio crée automatiquement le Gestionnaire d’événements approprié.
...
## <a name="step-5-programmatically-determining-the-value-of-the-data-in-the-databound-event-handler"></a>Étape 5 : Déterminer par programmation la valeur des données dans le Gestionnaire d’événement DataBound
...
**Figure 7**: pour les produits avec un suffisamment grandes Units In Stock, aucune mise en forme de personnalisé est appliqué ([cliquez pour afficher l’image en taille réelle](custom-formatting-based-upon-data-vb/_static/image17.png))
...
## <a name="step-8-programmatically-determining-the-value-of-the-data-in-the-rowdatabound-event-handler"></a>Étape 8 : Déterminer par programmation la valeur des données dans le Gestionnaire d’événement RowDataBound
...
**Figure 11**: produits abordable The Most sont mis en surbrillance en jaune ([cliquez pour afficher l’image en taille réelle](custom-formatting-based-upon-data-vb/_static/image27.png))
