...
ms.locfileid: "41825326"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="06cea-102">jQuery Templates bêta 1</span><span class="sxs-lookup"><span data-stu-id="06cea-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="06cea-103">Le plug-in de modèles jQuery inclut les fichiers suivants :</span><span class="sxs-lookup"><span data-stu-id="06cea-103">The jQuery Templates plugin includes the following files:</span></span>
