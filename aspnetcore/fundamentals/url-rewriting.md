...
Vous pouvez explorer les fonctionnalités de l’intergiciel de réécriture d’URL avec [l’exemple d’application de réécriture d’URL](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/). Cette application applique des règles de réécriture et de redirection, puis affiche l’URL réécrite ou redirigée.
...
* [Utilisation du module de réécriture d’URL 2.0 (pour IIS)](https://docs.microsoft.com/iis/extensions/url-rewrite-module/using-url-rewrite-module-20)
* [Informations de référence sur la configuration du module de réécriture d’URL](https://docs.microsoft.com/iis/extensions/url-rewrite-module/url-rewrite-module-configuration-reference)
