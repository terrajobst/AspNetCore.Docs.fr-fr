...
ms.locfileid: "41830130"
---
<a name="jquery-validation-1120"></a><span data-ttu-id="fee0a-102">jQuery Validation 1.12.0</span><span class="sxs-lookup"><span data-stu-id="fee0a-102">jQuery Validation 1.12.0</span></span>
====================
<span data-ttu-id="fee0a-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="fee0a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="fee0a-104">Localisation des fichiers au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js où ## est le code de localisation.</span><span class="sxs-lookup"><span data-stu-id="fee0a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.12.0/localization/messages\_##.js where ## is the loc code.</span></span>
