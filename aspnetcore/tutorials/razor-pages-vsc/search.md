...
> <span data-ttu-id="881a7-103">[Précédent : Mise à jour des pages](xref:tutorials/razor-pages-vsc/da1)
> [Suivant : Ajout d’un nouveau champ](xref:tutorials/razor-pages/new-field)</span><span class="sxs-lookup"><span data-stu-id="881a7-103">[Previous: Updating the pages](xref:tutorials/razor-pages-vsc/da1)
