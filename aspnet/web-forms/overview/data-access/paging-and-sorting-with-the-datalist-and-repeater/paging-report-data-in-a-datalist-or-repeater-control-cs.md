...
ms.locfileid: "37401933"
---
<a name="paging-report-data-in-a-datalist-or-repeater-control-c"></a>Pagination des données de rapport dans un contrôle DataList ou Repeater (c#)
====================
...
**Figure 8**: le premier quatre produits sont répertoriés ([cliquez pour afficher l’image en taille réelle](paging-report-data-in-a-datalist-or-repeater-control-cs/_static/image18.png))
