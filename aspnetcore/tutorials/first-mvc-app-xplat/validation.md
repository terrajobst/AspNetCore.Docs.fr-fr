...
ms.locfileid: "30897144"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="1d021-103">[Précédent - Ajouter un champ](new-field.md)
> [Suivant - Examiner les méthodes Details et Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="1d021-103">[Previous - Add a field](new-field.md)
