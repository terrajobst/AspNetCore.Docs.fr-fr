...
> - [API Web](../../index.md) (version 1 ou 2)
...
| --- | --- |
| **TÉLÉCHARGER** | Cette méthode est utilisée pour récupérer des données à partir d’un URI et probablement la méthode HTTP plus utilisées. |
