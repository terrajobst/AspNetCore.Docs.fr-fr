...
Une application configure l’implémentation de cache à l’aide un `RedisCache` instance (`AddStackExchangeRedisCache`) dans un environnement non liées au développement dans `Startup.ConfigureServices`:
