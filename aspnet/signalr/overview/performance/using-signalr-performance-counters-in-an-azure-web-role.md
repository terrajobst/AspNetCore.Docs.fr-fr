...
2. Dans Visual Studio 2015, sélectionnez **fichier** > **New** > **projet**.

3. Dans le **modèles** volet de la **nouveau projet** fenêtre sous la **Visual C#** nœud, sélectionnez le **Cloud** nœud et sélectionnez le **Azure Cloud Service** modèle. Nommez l’application **SignalRPerfCounters** et sélectionnez **OK**.
...
21. Créer un nouveau dossier dans le **WebRole1** projet nommé *Hubs*. Avec le bouton droit le *Hubs* dossier **l’Explorateur de solutions**, sélectionnez **Web** > **SignalR**, puis sélectionnez  **Classe de concentrateur SignalR (v2)**. Nommez le nouveau concentrateur *MyHub.cs* et sélectionnez **ajouter**.
