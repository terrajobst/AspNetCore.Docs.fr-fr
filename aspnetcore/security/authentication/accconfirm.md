...
Mise à jour `Startup.ConfigureServices` pour exiger un e-mail de confirmation :
...
Empêcher les utilisateurs qui vient d’être inscrits d’être connecté automatiquement en commentant la ligne suivante :
