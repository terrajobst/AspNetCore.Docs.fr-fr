...
ms.locfileid: "30071354"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="a2df3-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="a2df3-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="a2df3-103">Les fichiers suivants pour la plug-ins DataTables de jQuery sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="a2df3-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
