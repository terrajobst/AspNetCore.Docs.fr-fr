...
ms.locfileid: "30893896"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="dd0fe-103">[Précédent - Ajouter un modèle](adding-model.md)
> [Suivant - Méthodes et vues du contrôleur](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="dd0fe-103">[Previous - Add a model](adding-model.md)
