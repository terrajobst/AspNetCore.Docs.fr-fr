<span data-ttu-id="2d6e6-101">Exécutez le Générateur de modèles automatique identité :</span><span class="sxs-lookup"><span data-stu-id="2d6e6-101">Run the Identity scaffolder:</span></span>
