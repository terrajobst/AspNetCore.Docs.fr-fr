...
- Modèles : Les Classes qui représentent les données de l’application et qui utilisent une logique de validation pour appliquer des règles d’entreprise pour ces données.
- Vues : Fichiers de modèle votre application utilise pour générer dynamiquement des réponses HTML.
