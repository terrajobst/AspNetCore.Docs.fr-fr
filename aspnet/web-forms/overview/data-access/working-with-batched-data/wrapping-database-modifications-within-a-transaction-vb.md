...
ms.locfileid: "37390160"
---
<a name="wrapping-database-modifications-within-a-transaction-vb"></a>Inclusion de Modifications de base de données dans une Transaction (VB)
====================
...
**Figure 5**: configurer ObjectDataSource à utiliser le `ProductsBLL` classe s `GetProducts` (méthode) ([cliquez pour afficher l’image en taille réelle](wrapping-database-modifications-within-a-transaction-vb/_static/image4.png))
