...
Dans 3.0, la compilation pour le runtime est un scénario opt-in. Pour activer la compilation pour le runtime, consultez https://docs.microsoft.com/aspnet/core/mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation.
