...
> [!IMPORTANT]
> Cet exemple utilise le Kit de développement logiciel ASP.NET Core 2.2 Preview 2 et le runtime. Obtenir la version préliminaire à partir de [téléchargements .NET Core 2.2](https://www.microsoft.com/net/download/dotnet-core/2.2). Confirmer la version SDK dans le *global.json* fichier et le [Microsoft.AspNetCore.App métapackage](xref:fundamentals/metapackage-app) version sont corrects dans le fichier projet pour votre Kit de développement logiciel et la version du framework partagé.

Cet exemple illustre l’utilisation d’ASP.NET Core 2.x intergiciel de Compression des réponses pour compresser les réponses HTTP pour. L’exemple montre comment Gzip, Brotli et fournisseurs de compression personnalisé pour les réponses de type text et image et montre comment ajouter un type MIME pour la compression. Pour obtenir l’exemple ASP.NET Core 1.x, consultez [réponse compression exemple d’application (ASP.NET Core 1.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/performance/response-compression/samples/1.x).
