...
---
<a name="jquery-validation-1150"></a><span data-ttu-id="cc4fe-102">jQuery Validation 1.15.0</span><span class="sxs-lookup"><span data-stu-id="cc4fe-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="cc4fe-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="cc4fe-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="cc4fe-104">Localisation des fichiers au https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js où ## est le code de localisation.</span><span class="sxs-lookup"><span data-stu-id="cc4fe-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
