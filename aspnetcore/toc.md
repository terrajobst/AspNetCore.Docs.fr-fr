...
## [Hébergement](fundamentals/hosting.md)
...
### [Les Tag Helpers](mvc/views/tag-helpers/intro.md)
...
### [Les filtres](mvc/controllers/filters.md)
### [Les zones (areas)](mvc/controllers/areas.md)
...
## [Ajouter des fonctionnalités d’application à l’aide d’une configuration spécifique à une plateforme](xref:host-and-deploy/platform-specific-configuration)
