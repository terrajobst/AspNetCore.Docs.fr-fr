...
**Figure 1**: le résultat de ce didacticiel complet ([cliquez pour afficher l’image en taille réelle](master-pages-and-site-navigation-vb/_static/image3.png))
...
**Figure 5**: ajouter un nouveau formulaire Web, la vérification de la case à cocher Sélectionner la page maître ([cliquez pour afficher l’image en taille réelle](master-pages-and-site-navigation-vb/_static/image13.png))
...
**Figure 7**: la vue de conception pour l’ASP.NET Page montre à la fois le modifiable et Non-éditable régions ([cliquez pour afficher l’image en taille réelle](master-pages-and-site-navigation-vb/_static/image19.png))
