...
* Dans la boîte de dialogue **Créer un projet**, sélectionnez **Service gPRC**, puis sélectionnez **Suivant** :
...
* Utilisation du `HttpClient` pour construire un canal gRPC et le client Greeter :
