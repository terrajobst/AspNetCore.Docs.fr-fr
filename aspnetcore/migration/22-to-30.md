...
#### <a name="framework-dependent-builds-using-docker"></a>Builds dépendantes de Framework à l’aide de Dockr

Les builds dépendantes de l’infrastructure des applications console qui utilisent un package qui dépend de l' [infrastructure partagée](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/) ASP.net Core peuvent fournir l’erreur d’exécution suivante :
...
* Entity Framework Core &ndash; pour plus d’informations sur le référencement du package spécifique au fournisseur de base de données, consultez [fournisseurs de bases de données](/ef/core/providers/index).
...
## <a name="mysqldataentityframeworkcore-currently-not-supported-on-aspnet-core-30"></a>MySql. Data. EntityFrameworkCore actuellement non pris en charge sur ASP.NET Core 3,0
