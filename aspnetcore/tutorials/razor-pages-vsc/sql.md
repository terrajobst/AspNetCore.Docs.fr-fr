...
> <span data-ttu-id="e50f3-103">[Précédent : Ajout d’un modèle](xref:tutorials/razor-pages-vsc/model)
> [Suivant : Mettre à jour les pages](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="e50f3-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
