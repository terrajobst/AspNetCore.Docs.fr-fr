...
Si vous n’êtes pas familiarisé avec les extraits de Code Visual Studio et que vous souhaitiez savoir comment les utiliser, vous pouvez faire référence à l’annexe de ce document &quot; [extraits de Code à l’aide d’annexe a :](#AppendixA)&quot;.
...
> [!NOTE]
> Le format de base d’une requête de média est : @media \[étendue : tous les | portables | imprimer | projection | écran\] ([ : valeur de propriété] et... propriété : valeur)


Exemples de requêtes de média : &gt;  <strong>@media tous les et (la largeur maximale : 1000px) et (la largeur min : 700px) {}:</strong> pour toutes les résolutions entre 700px et 1000px.

> <strong>@media écran et (min-width : 400px) et (la largeur maximale : 700px) {...} :</strong> uniquement pour les écrans. La résolution doit être compris entre 400 et 700px.
> 
> <strong>@media portables et (la largeur min : 20em), écran et (la largeur min : 20em) {...} :</strong> pour les écrans et les ordinateurs de poche (mobile et appareils). La largeur minimale doit être supérieure à 20em.
> 
...
> [!NOTE]
> En outre, vous pouvez déployer cette application à Sites Web Windows Azure suit [publication annexe d : une Application ASP.NET MVC 4, à l’aide de Web Deploy](#AppendixD).
...
## <a name="appendix-c-installing-webmatrix-2-and-iphone-simulator"></a>Annexe c : installation de WebMatrix 2 et iPhone simulateur
