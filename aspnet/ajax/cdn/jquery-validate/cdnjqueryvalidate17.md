...
ms.locfileid: "37836475"
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="6377c-102">jQuery.Validate version 1.7</span><span class="sxs-lookup"><span data-stu-id="6377c-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="6377c-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="6377c-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="6377c-104">Fichiers de localisation</span><span class="sxs-lookup"><span data-stu-id="6377c-104">Localization Files</span></span>
