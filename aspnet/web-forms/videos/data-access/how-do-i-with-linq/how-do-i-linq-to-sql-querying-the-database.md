...
Cette vidéo montre comment interroger une base de données avec LINQ, le SQL sous-jacent avec un visualiseur de requête, la liaison de données pour les contrôles ASP.NET et la pagination enregistrement.
