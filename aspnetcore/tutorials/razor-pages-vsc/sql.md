...
ms.locfileid: "36960630"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="d0bba-103">[Précédent : Ajout d’un modèle](xref:tutorials/razor-pages-vsc/model)
> [Suivant : Mettre à jour les pages](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="d0bba-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
