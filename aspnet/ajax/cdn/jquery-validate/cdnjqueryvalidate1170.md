...
ms.locfileid: "30073032"
---
<a name="jquery-validation-1170"></a><span data-ttu-id="f4ec9-102">jQuery Validation 1.17.0</span><span class="sxs-lookup"><span data-stu-id="f4ec9-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="f4ec9-103">Les fichiers suivants sont hébergés sur le CDN :</span><span class="sxs-lookup"><span data-stu-id="f4ec9-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="f4ec9-104">Les fichiers de localisation https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages \_## .js où ## est le code d’emplacement.</span><span class="sxs-lookup"><span data-stu-id="f4ec9-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
