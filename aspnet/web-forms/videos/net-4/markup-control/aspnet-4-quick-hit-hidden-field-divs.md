...
---
<a name="aspnet-4-quick-hit---hidden-field-divs"></a>ASP.NET 4 « Accès rapide » - masqué balises div de champ
====================
par [Joe Stagner](https://github.com/JoeStagner)

Dans cette vidéo, vous allez apprendre comment les éléments div autour des champs masqués sont filtrables maintenant afin qu’ils n’interfèrent pas avec des règles CSS créés par l’utilisateur.
