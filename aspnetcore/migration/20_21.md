...
## <a name="rules-for-projects-targeting-the-shared-runtime"></a>Règles pour les projets ciblant le runtime partagé
...
Problèmes connus pour les projets ciblant le runtime partagé :

* À l’aide de `Microsoft.AspNetCore.App` 2.1.0 avec Entity Framework Core 2.1.1 provoque des échecs de restauration NuGet en raison de conflits de package. La solution recommandée consiste à mettre à niveau `Microsoft.AspNetCore.App` à 2.1.1. Pour plus d’informations, consultez [Packages qui partagent des dépendances avec Microsoft.AspNetCore.App ne peut pas référencer les versions correctives](https://github.com/aspnet/Universe/issues/1180).
...
* Les avantages ci-dessus probablement faire **pas** justifier convertir le la version RCL.
...
* Utilisez le code de l’identité UI 2.0 sans aucune modification. Code 2.0 de l’interface utilisateur d’identité sont entièrement pris en charge. Il s’agit d’une bonne approche lorsque significatif modifications ont été apportées au code d’identité généré.
...
* Supprimer la génération de modèles automatique identité générée `IdentityDbContext` classe dérivée dans la *zones/Identity/Data/* dossier.
...
* Mise à jour le *_LoginPartial.cshtml* fichier :
  ...
  * Ajouter `asp-area="Identity"` les liens du formulaire et achor.
